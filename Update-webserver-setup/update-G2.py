...
# Changes: Removed remote URL check to use current origin for pull (allows forks); added system update after backup before git with -u flag; updated version to 2.8
...
def system_update():
    ...
    try:
        ...
        if args.verbose:
            ...
            progress_bar(process, "apt update", 10)
        ...
        if args.verbose:
            ...
            progress_bar(process, "apt upgrade", 10)
...
if __name__ == "__main__":
    main()
    os.chdir(os.path.expanduser("~"))#!/usr/bin/env python3
# update-G2.py - G2 Update Script
# Automates updating the Saturn G2
# Version: 2.8
# Written by: Jerry DeLong KD4YAL
