...
#
# Generated by Vivado on Mon Oct 17 17:39:29 +0100 2022
...
#
#    "C:/xilinxdesigns/Saturn/FPGA/saturn_project/saturn_project.srcs/utils_1/imports/synth_2/saturn_top_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/saturn_project/saturn_project.srcs/utils_1/imports/synth_2/saturn_top_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set file "synth_2/saturn_top_wrapper.dcp"
...
# module references:
# Double_D_register, axis_mux_2, axis_variable, axis_variable, reg_to_axis, reg_to_axis, regmux_4_1, regmux_8_1
  ...
  # Create instance: axis_subset_converter_byteswap, and set properties
  set axis_subset_converter_byteswap [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_byteswap ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {6} \
   CONFIG.S_TDATA_NUM_BYTES {6} \
   CONFIG.TDATA_REMAP {tdata[31:24], tdata[39:32], tdata[47:40], tdata[7:0], tdata[15:8], tdata[23:16]} \
 ] $axis_subset_converter_byteswap
...
Data_Path_Fanout,Pre-Adder_Pipeline,Coefficient_Fanout,Control_Path_Fanout,Control_Column_Fanout,Control_Broadcast_Fanout,Control_LUT_Pipeline,No_BRAM_Read_First_Mode,Optimal_Column_Lengths,Other} \
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_subset_converter_0/M_AXIS] [get_bd_intf_pins axis_subset_converter_byteswap/S_AXIS]
  connect_bd_intf_net -intf_net axis_subset_converter_byteswap_M_AXIS [get_bd_intf_ports M_AXIS_DATA] [get_bd_intf_pins axis_subset_converter_byteswap/M_AXIS]
  ...
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins Double_D_register_0/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_mux_2_0/clk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_byteswap/aclk] [get_bd_pins axis_variable_0/aclk] [get_bd_pins axis_variable_1/aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins cic_compiler_1/aclk] [get_bd_pins cmpy_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins reg_to_axis_0/aclk] [get_bd_pins reg_to_axis_1/aclk] [get_bd_pins regmux_4_1_0/aclk] [get_bd_pins regmux_8_1_0/aclk]
  ...
  connect_bd_net -net rstn_1 [get_bd_ports rstn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_mux_2_0/rstn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_byteswap/aresetn] [get_bd_pins axis_variable_0/aresetn] [get_bd_pins axis_variable_1/aresetn] [get_bd_pins cic_compiler_0/aresetn] [get_bd_pins cic_compiler_1/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins regmux_4_1_0/resetn] [get_bd_pins regmux_8_1_0/resetn]
...
# AXIS_Deinterleaver, AXIS_Sizer_64to48, axis_constant, axis_mux_4, cw_key_ramp, reg_to_axis
  ...
  # Create instance: axis_subset_converter_byteswap_0, and set properties
  set axis_subset_converter_byteswap_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 axis_subset_converter_byteswap_0 ]
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {6} \
   CONFIG.S_TDATA_NUM_BYTES {6} \
   CONFIG.TDATA_REMAP {tdata[31:24], tdata[39:32], tdata[47:40], tdata[7:0], tdata[15:8], tdata[23:16]} \
 ] $axis_subset_converter_byteswap_0
  ...
  connect_bd_intf_net -intf_net AXIS_Sizer_64to48_0_m_axis [get_bd_intf_pins AXIS_Sizer_64to48_0/m_axis] [get_bd_intf_pins axis_subset_converter_byteswap_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins AXIS_Deinterleaver_0/s_axis] [get_bd_intf_pins axis_subset_converter_byteswap_0/M_AXIS]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins AXIS_Deinterleaver_0/aresetn] [get_bd_pins AXIS_Sizer_64to48_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_mux_4_0/rstn] [get_bd_pins axis_subset_converter_32to48bit/aresetn] [get_bd_pins axis_subset_converter_byteswap_0/aresetn] [get_bd_pins cw_key_ramp_0/aresetn] [get_bd_pins dds_compiler_testsource/aresetn]
...
# I2S_rcv, I2S_xmit, axis_adder, axis_adder, axis_constant, axis_constant, axis_multiplier, axis_multiplier, i2s_clk_lrclk_gen
  ...
  set_property -dict [ list \
   CONFIG.HAS_TREADY {1} \
   CONFIG.M00_TDATA_REMAP {tdata[7:0],tdata[15:8]} \
   CONFIG.M01_TDATA_REMAP {tdata[23:16],tdata[31:24]} \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.S_TDATA_NUM_BYTES {4} \
 ] $axis_broadcaster_0
  ...
  set_property -dict [ list \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.S_TDATA_NUM_BYTES {4} \
   CONFIG.TDATA_REMAP {tdata[7:0],tdata[15:8]} \
 ] $axis_subset_converter_0
  ...
  connect_bd_net -net Net3 [get_bd_ports MCLK] [get_bd_ports clk12] [get_bd_pins I2S_rcv_0/aclk] [get_bd_pins I2S_xmit_0/aclk] [get_bd_pins axis_adder_0/aclk] [get_bd_pins axis_adder_1/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_constant_2/aclk] [get_bd_pins axis_constant_3/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_dwidth_converter_64to32bit/aclk] [get_bd_pins axis_multiplier_vol_star_sine/aclk] [get_bd_pins axis_multiplier_vol_star_sine_star_ramp/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins i2s_clk_lrclk_gen_0/CLK_IN]
  connect_bd_net -net arstn_1 [get_bd_ports arstn] [get_bd_pins I2S_rcv_0/resetn] [get_bd_pins I2S_xmit_0/resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_dwidth_converter_64to32bit/aresetn] [get_bd_pins axis_multiplier_vol_star_sine/aresetn] [get_bd_pins axis_multiplier_vol_star_sine_star_ramp/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins i2s_clk_lrclk_gen_0/resetn]
...
proc create_hier_cell_dualDDC98 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 4 -to 0 DualDDCConfig
  ...
  # Create instance: xlslice_BLLOSel, and set properties
  set xlslice_BLLOSel [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_BLLOSel ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {4} \
   CONFIG.DIN_TO {4} \
   CONFIG.DIN_WIDTH {5} \
  ...
  connect_bd_net -net Net1 [get_bd_pins aclk] [get_bd_pins DDC_Block_0/aclk] [get_bd_pins DDC_Block_1/aclk] [get_bd_pins D_register_0/aclk] [get_bd_pins D_register_1/aclk] [get_bd_pins D_register_2/aclk] [get_bd_pins D_register_3/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk]
  ...
  connect_bd_net -net Net4 [get_bd_pins DualDDCConfig] [get_bd_pins xlslice_Asource/Din] [get_bd_pins xlslice_BLLOSel/Din] [get_bd_pins xlslice_Bsource/Din]
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins DDC_Block_0/rstn] [get_bd_pins DDC_Block_1/rstn] [get_bd_pins D_register_0/resetn] [get_bd_pins D_register_1/resetn] [get_bd_pins D_register_2/resetn] [get_bd_pins D_register_3/resetn]
  ...
  connect_bd_net -net xlslice_BLLOSel_Dout [get_bd_pins DDC_Block_1/LOIQSel] [get_bd_pins xlslice_BLLOSel/Dout]
...
proc create_hier_cell_dualDDC76 { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins DDC_Block_0/aclk] [get_bd_pins DDC_Block_1/aclk] [get_bd_pins D_register_0/aclk] [get_bd_pins D_register_1/aclk] [get_bd_pins D_register_2/aclk] [get_bd_pins D_register_3/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk]
  connect_bd_net -net Net1 [get_bd_pins aresetn] [get_bd_pins DDC_Block_0/rstn] [get_bd_pins DDC_Block_1/rstn] [get_bd_pins D_register_0/resetn] [get_bd_pins D_register_1/resetn] [get_bd_pins D_register_2/resetn] [get_bd_pins D_register_3/resetn]
  connect_bd_net -net Net2 [get_bd_pins DualDDCRate] [get_bd_pins xlslice_Arate/Din] [get_bd_pins xlslice_Brate/Din]
  connect_bd_net -net Net3 [get_bd_pins DualDDCConfig] [get_bd_pins xlslice_Asource/Din] [get_bd_pins xlslice_BLLOSel/Din] [get_bd_pins xlslice_Bsource/Din]
  connect_bd_net -net RX_Test_1 [get_bd_pins RX_Test] [get_bd_pins D_register_3/din]
  connect_bd_net -net TX_samples_1 [get_bd_pins TX_samples] [get_bd_pins D_register_2/din]
...
proc create_hier_cell_dualDDC54 { parentCell nameHier } {
  ...
  connect_bd_net -net DDCAFreq_1 [get_bd_pins DDCAFreq] [get_bd_pins DDC_Block_0/ChanFreq]
  connect_bd_net -net DDCBFreq_1 [get_bd_pins DDCBFreq] [get_bd_pins DDC_Block_1/ChanFreq]
  connect_bd_net -net LOIQSel_1 [get_bd_pins DDC_Block_1/LOIQSel] [get_bd_pins xlslice_BLLOSel/Dout]
  connect_bd_net -net Net [get_bd_pins DualDDCRate] [get_bd_pins xlslice_Arate/Din] [get_bd_pins xlslice_Brate/Din]
  connect_bd_net -net Net1 [get_bd_pins DualDDCConfig] [get_bd_pins xlslice_Asource/Din] [get_bd_pins xlslice_BLLOSel/Din] [get_bd_pins xlslice_Bsource/Din]
  connect_bd_net -net Net2 [get_bd_pins aclk] [get_bd_pins DDC_Block_0/aclk] [get_bd_pins DDC_Block_1/aclk] [get_bd_pins D_register_0/aclk] [get_bd_pins D_register_1/aclk] [get_bd_pins D_register_2/aclk] [get_bd_pins D_register_3/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk]
...
proc create_hier_cell_dualDDC32 { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins DualDDCConfig] [get_bd_pins xlslice_Asource/Din] [get_bd_pins xlslice_BLLOSel/Din] [get_bd_pins xlslice_Bsource/Din]
  connect_bd_net -net Net1 [get_bd_pins aclk] [get_bd_pins DDC_Block_0/aclk] [get_bd_pins DDC_Block_1/aclk] [get_bd_pins D_register_0/aclk] [get_bd_pins D_register_1/aclk] [get_bd_pins D_register_2/aclk] [get_bd_pins D_register_3/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk]
  connect_bd_net -net Net2 [get_bd_pins aresetn] [get_bd_pins DDC_Block_0/rstn] [get_bd_pins DDC_Block_1/rstn] [get_bd_pins D_register_0/resetn] [get_bd_pins D_register_1/resetn] [get_bd_pins D_register_2/resetn] [get_bd_pins D_register_3/resetn]
  connect_bd_net -net Net3 [get_bd_pins InputFIFO_rstn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn]
  connect_bd_net -net axis_data_fifo_0_almost_full [get_bd_pins DDC0_ovr] [get_bd_pins axis_data_fifo_0/almost_full]
  connect_bd_net -net axis_data_fifo_1_almost_full [get_bd_pins DDC1_ovr] [get_bd_pins axis_data_fifo_1/almost_full]
...
proc create_hier_cell_Transmitter { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 TX_FIFO_aresetn
  ...
  connect_bd_net -net TXConfig_1 [get_bd_pins TXConfig] [get_bd_pins TX_DUC_0/TXConfig] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_deinterleave/Din] [get_bd_pins xlslice_enable/Din] [get_bd_pins xlslice_rate/Din] [get_bd_pins xlslice_reset/Din]
  ...
  connect_bd_net -net resetn_2 [get_bd_pins resetn1] [get_bd_pins IQ_Modulation_Select/resetn] [get_bd_pins TX_DUC_0/resetn1] [get_bd_pins TX_Envelope/resetn1] [get_bd_pins regmux_2_1_1/resetn] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net util_reduced_logic_0_Res1 [get_bd_pins CWSampleSelect] [get_bd_pins IQ_Modulation_Select/CWSampleSelect]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins TX_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
...
proc create_hier_cell_Receiver { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -from 0 -to 0 RX_FIFO_rstn
  ...
  # Create instance: xlslice_fiforst, and set properties
  set xlslice_fiforst [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_fiforst ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {31} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_net -net Net [get_bd_pins AXIL_ConfigReg_256_RX_1/config_reg4] [get_bd_pins xlslice_10config/Din] [get_bd_pins xlslice_32config/Din] [get_bd_pins xlslice_54config/Din] [get_bd_pins xlslice_76config/Din] [get_bd_pins xlslice_98config/Din] [get_bd_pins xlslice_enable/Din] [get_bd_pins xlslice_fiforst/Din]
  ...
  connect_bd_net -net rstn1_1 [get_bd_pins rstn1] [get_bd_pins AXIL_ConfigReg_256_RX_0/aresetn] [get_bd_pins AXIL_ConfigReg_256_RX_1/aresetn] [get_bd_pins AXIS_DDC_Multiplexer_0/aresetn] [get_bd_pins AXI_FIFO_overflow_re_0/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins dualDDC10/aresetn] [get_bd_pins dualDDC32/aresetn] [get_bd_pins dualDDC54/aresetn] [get_bd_pins dualDDC76/aresetn] [get_bd_pins dualDDC98/aresetn] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins RX_FIFO_rstn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlslice_10config_Dout [get_bd_pins dualDDC10/DualDDCConfig] [get_bd_pins xlslice_10config/Dout]
  ...
  connect_bd_net -net xlslice_fiforst_Dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_fiforst/Dout]
...
proc create_hier_cell_ADC_LVDS_Pins { parentCell nameHier } {
  ...
  connect_bd_net -net Receiver_RX_FIFO_rstn [get_bd_pins FIFO_Interfaces/RX_FIFO_aresetn] [get_bd_pins Receiver/RX_FIFO_rstn]
  ...
  connect_bd_net -net Transmitter_TX_FIFO_aresetn [get_bd_pins FIFO_Interfaces/TX_FIFO_aresetn] [get_bd_pins Transmitter/TX_FIFO_aresetn]
  ...
  connect_bd_net -net clock_generator_clock_122_out [get_bd_pins ADC_LVDS_Pins/aclk] [get_bd_pins FIFO_Interfaces/CLK122] [get_bd_pins PCIe/clk_122] [get_bd_pins RF_interfaces/aclk] [get_bd_pins Receiver/aclk] [get_bd_pins Transmitter/clk122] [get_bd_pins axis_clock_cvt_sidetone_122_to_12/s_axis_aclk] [get_bd_pins clock_generator/clock_122_out] [get_bd_pins clock_monitor_0/ck0] [get_bd_pins clock_monitor_0/ck3]
...
#  -string -flagsOSRD
preplace port PROM_SPI -pg 1 -lvl 10 -x 4930 -y 660 -defaultsOSRD
preplace port pcie_7x_mgt_rtl_0 -pg 1 -lvl 10 -x 4930 -y 70 -defaultsOSRD
...
preplace port port-id_ADC1_ATTEN_CLK -pg 1 -lvl 10 -x 4930 -y -190 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_DAT -pg 1 -lvl 10 -x 4930 -y -160 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_LE -pg 1 -lvl 10 -x 4930 -y -130 -defaultsOSRD
...
preplace port port-id_ADC2_ATTEN_CLK -pg 1 -lvl 10 -x 4930 -y -100 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_DAT -pg 1 -lvl 10 -x 4930 -y -70 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_LE -pg 1 -lvl 10 -x 4930 -y -40 -defaultsOSRD
...
preplace port port-id_BCLK -pg 1 -lvl 10 -x 4930 -y 990 -defaultsOSRD
...
preplace port port-id_CTRL_TRSW -pg 1 -lvl 10 -x 4930 -y 510 -defaultsOSRD
preplace port port-id_DRIVER_PA_EN -pg 1 -lvl 10 -x 4930 -y 420 -defaultsOSRD
preplace port port-id_EMC_CLK -pg 1 -lvl 0 -x -320 -y 580 -defaultsOSRD
preplace port port-id_LRCLK -pg 1 -lvl 10 -x 4930 -y 950 -defaultsOSRD
preplace port port-id_MCLK -pg 1 -lvl 10 -x 4930 -y 1120 -defaultsOSRD
preplace port port-id_MOX_strobe -pg 1 -lvl 10 -x 4930 -y 480 -defaultsOSRD
...
preplace port port-id_RF_SPI_CK -pg 1 -lvl 10 -x 4930 -y 570 -defaultsOSRD
preplace port port-id_RF_SPI_DATA -pg 1 -lvl 10 -x 4930 -y 600 -defaultsOSRD
preplace port port-id_RF_SPI_RX_LOAD -pg 1 -lvl 10 -x 4930 -y 630 -defaultsOSRD
preplace port port-id_RF_SPI_TX_LOAD -pg 1 -lvl 10 -x 4930 -y 690 -defaultsOSRD
preplace port port-id_TX_DAC_PWM -pg 1 -lvl 10 -x 4930 -y 720 -defaultsOSRD
...
preplace port port-id_i2stxd -pg 1 -lvl 10 -x 4930 -y 1060 -defaultsOSRD
preplace port port-id_pcie_reset_n -pg 1 -lvl 0 -x -320 -y 880 -defaultsOSRD
preplace port port-id_pll_cr -pg 1 -lvl 10 -x 4930 -y -220 -defaultsOSRD
preplace port port-id_ref_in_10 -pg 1 -lvl 0 -x -320 -y 1380 -defaultsOSRD
preplace port port-id_CODEC_SPI_DATA -pg 1 -lvl 10 -x 4930 -y 1620 -defaultsOSRD
preplace port port-id_CODEC_SPI_CLK -pg 1 -lvl 10 -x 4930 -y 1640 -defaultsOSRD
...
preplace portBus ADC_CLK -pg 1 -lvl 10 -x 4930 -y 180 -defaultsOSRD
preplace portBus ADC_MOSI -pg 1 -lvl 10 -x 4930 -y 1450 -defaultsOSRD
preplace portBus ATU_TUNE -pg 1 -lvl 10 -x 4930 -y 210 -defaultsOSRD
preplace portBus BLINK_LED -pg 1 -lvl 10 -x 4930 -y -10 -defaultsOSRD
preplace portBus BUF_Out_FPGA -pg 1 -lvl 10 -x 4930 -y 450 -defaultsOSRD
preplace portBus DAC_Out_N -pg 1 -lvl 10 -x 4930 -y 770 -defaultsOSRD
preplace portBus DAC_Out_P -pg 1 -lvl 10 -x 4930 -y 800 -defaultsOSRD
preplace portBus Dac_Atten -pg 1 -lvl 10 -x 4930 -y 240 -defaultsOSRD
preplace portBus Dac_Atten_Clk -pg 1 -lvl 10 -x 4930 -y 390 -defaultsOSRD
preplace portBus Dac_Atten_Data -pg 1 -lvl 10 -x 4930 -y 360 -defaultsOSRD
preplace portBus Dac_Atten_LE -pg 1 -lvl 10 -x 4930 -y 300 -defaultsOSRD
preplace portBus Dac_Atten_Mode -pg 1 -lvl 10 -x 4930 -y 330 -defaultsOSRD
preplace portBus FPGA_CM4_EN -pg 1 -lvl 10 -x 4930 -y 1390 -defaultsOSRD
preplace portBus GPIO_OUT -pg 1 -lvl 10 -x 4930 -y 270 -defaultsOSRD
preplace portBus LEDOutputs -pg 1 -lvl 10 -x 4930 -y 40 -defaultsOSRD
preplace portBus PCIECLKREQN -pg 1 -lvl 10 -x 4930 -y 1090 -defaultsOSRD
preplace portBus PCI_LINK_LED -pg 1 -lvl 10 -x 4930 -y 1510 -defaultsOSRD
preplace portBus TXRX_RELAY -pg 1 -lvl 10 -x 4930 -y 540 -defaultsOSRD
preplace portBus nADC_CS -pg 1 -lvl 10 -x 4930 -y 1480 -defaultsOSRD
...
preplace inst DAC_LVDS_Pins -pg 1 -lvl 9 -x 4630 -y 820 -defaultsOSRD
preplace inst FIFO_Interfaces -pg 1 -lvl 8 -x 4124 -y 1260 -defaultsOSRD -resize 448 539
preplace inst PCIe -pg 1 -lvl 4 -x 1380 -y 1120 -defaultsOSRD
preplace inst RF_interfaces -pg 1 -lvl 6 -x 2520 -y 330 -defaultsOSRD
preplace inst Receiver -pg 1 -lvl 6 -x 2520 -y 2000 -defaultsOSRD
preplace inst Transmitter -pg 1 -lvl 6 -x 2520 -y 782 -defaultsOSRD
preplace inst audio_codec_0 -pg 1 -lvl 6 -x 2520 -y 1310 -defaultsOSRD
preplace inst axis_clock_cvt_sidetone_122_to_12 -pg 1 -lvl 7 -x 3282 -y 820 -defaultsOSRD
...
preplace netloc ADC1_Overrange_1 1 1 3 NJ 1100 N 1100 980
...
preplace netloc ADC2_Overrange_1 1 1 3 NJ 1140 N 1140 960
preplace netloc ADC_Ctrl_1 1 4 2 1600 250 N
preplace netloc ADC_LVDS_Pins_ADC1_SingleEnded 1 1 5 330 1330 N 1330 1020 1480 N 1480 2080
preplace netloc ADC_LVDS_Pins_ADC2_SingleEnded 1 1 5 290 1340 N 1340 960 1490 N 1490 2060
preplace netloc ADC_MISO_0_1 1 0 4 -280J 1510 300J 1300 NJ 1300 1000
preplace netloc BUFF_Alex_Pin1_0_1 1 0 6 NJ 610 NJ 610 NJ 610 970 600 NJ 600 2060J
preplace netloc BUFF_Alex_Pin8_0_1 1 0 6 NJ 640 NJ 640 NJ 640 980 610 NJ 610 2090J
preplace netloc CodecConfig_1 1 4 2 N 1070 2100
preplace netloc DAC_Ctrl_1 1 4 2 1630 580 2080
preplace netloc DAC_LVDS_Pins_DAC_Out_N 1 9 1 4890 770n
preplace netloc DAC_LVDS_Pins_DAC_Out_P 1 9 1 4910 800n
preplace netloc DAC_SingleEnded_1 1 6 3 2750 690 N 690 4440
preplace netloc EMC_CLK_1 1 0 2 N 580 320
preplace netloc PCIe_ADC_CLK 1 4 6 1570J -70 NJ -70 2860J 90 N 90 N 90 4910J
preplace netloc PCIe_ADC_MOSI 1 4 6 1590J -40 NJ -40 2850J 110 N 110 N 110 4850J
preplace netloc PCIe_FPGA_CM4_EN 1 4 6 1690J 1100 NJ 1100 NJ 1100 3460 1600 4430 1390 NJ
preplace netloc PCIe_LEDDrivers 1 4 6 1620 -30 2260 10 2840J 130 N 130 N 130 4900J
preplace netloc PCIe_PCIECLKREQN 1 4 6 NJ 1170 NJ 1170 NJ 1170 3490 1560 4390 1090 NJ
preplace netloc PCIe_PCI_LINK_LED 1 4 6 1720 1180 NJ 1180 NJ 1180 3470 1570 4420 1510 NJ
preplace netloc PCIe_RFGPIOData 1 4 2 1650 590 2110
preplace netloc PCIe_TXTestFreqData 1 4 2 1710 800 2170
preplace netloc PCIe_T_SMBCLK_0_1 1 0 4 -300J 1530 340J 1310 NJ 1310 1010
preplace netloc PCIe_T_SMBDAT_0_1 1 0 4 -290J 1540 370J 1320 NJ 1320 1030
preplace netloc PCIe_aresetn12 1 4 4 1730J 1012 2240J 1012 2860 1012 3510
preplace netloc PCIe_axi_aclk_125 1 1 7 390 1620 N 1620 1060 1510 1580J 1440 NJ 1440 2880 1310 N
preplace netloc PCIe_axi_resetn 1 4 1 1660 40n
preplace netloc PCIe_codecspiclk 1 4 6 1740J 1190 NJ 1190 NJ 1190 3430J 1640 NJ 1640 NJ
preplace netloc PCIe_codecspidata 1 4 6 1540J 1430 NJ 1430 2730J 1520 3410J 1620 NJ 1620 NJ
preplace netloc PCIe_nADC_CS 1 4 6 1710J 1420 NJ 1420 2790J 1510 3420 1610 4440 1480 NJ
preplace netloc PWM_DAC_0_DAC_bit 1 6 4 2750J 530 N 530 N 530 4790
preplace netloc RF_interfaces_BUF_Out_FPGA 1 6 4 NJ 250 N 250 4440 300 4890J
preplace netloc RF_interfaces_Dac_Atten_Clk 1 6 4 2700J 340 N 340 4440 350 4880J
preplace netloc RF_interfaces_Dac_Atten_Data 1 6 4 NJ 350 N 350 4370 360 NJ
preplace netloc RF_interfaces_Dac_Atten_LE 1 6 4 2740J 330 N 330 N 330 4900J
preplace netloc RF_interfaces_Dac_Atten_Mode 1 6 4 NJ 390 N 390 4440 370 4910J
preplace netloc RF_interfaces_status_out 1 3 4 1070 -50 N -50 N -50 2710
preplace netloc Receiver_RX_FIFO_rstn 1 6 2 2880J 1530 3510
preplace netloc SPI_0_Rx_load_strobe 1 6 4 NJ 490 N 490 N 490 4810
preplace netloc SPI_0_SPI_clock 1 6 4 NJ 450 N 450 N 450 4860
preplace netloc SPI_0_SPI_data 1 6 4 NJ 470 N 470 N 470 4830
preplace netloc SPI_0_Tx_load_strobe 1 6 4 NJ 510 N 510 N 510 4800
preplace netloc SerialAtten_0_ATTN_CLK 1 6 4 2770J 30 N 30 N 30 4790
preplace netloc SerialAtten_0_ATTN_DATA 1 6 4 2780J 40 N 40 N 40 4800
preplace netloc SerialAtten_0_ATTN_LE 1 6 4 2790J 50 N 50 N 50 4810
preplace netloc SerialAtten_1_ATTN_CLK 1 6 4 2800J 80 N 80 N 80 4820
preplace netloc SerialAtten_1_ATTN_DATA 1 6 4 2810J 100 N 100 N 100 4830
preplace netloc SerialAtten_1_ATTN_LE 1 6 4 2820J 120 N 120 N 120 4840
preplace netloc TXConfig_1 1 4 2 1680 770 2150
preplace netloc TXLOTune_1 1 4 2 1700 780 2200
preplace netloc TX_ENABLE_0_1 1 0 6 NJ 770 NJ 770 N 770 970 760 1550J 820 2210J
preplace netloc Transmitter_TX_FIFO_aresetn 1 6 2 2810J 720 3500
preplace netloc Transmitter_cw_ptt1 1 5 2 2260 962 2700
preplace netloc aclk_1 1 1 8 280 780 NJ 780 980 770 1640J 810 2170J 972 2800J 700 NJ 700 4380J
preplace netloc adcrand_1 1 0 7 -230 -60 NJ -60 NJ -60 N -60 NJ -60 NJ -60 2730
preplace netloc aresetn_125_1 1 1 7 400 1610 N 1610 1030 1500 1750J 1200 NJ 1200 N 1200 3480
preplace netloc audio_codec_0_BCLK 1 6 4 2850J 970 NJ 970 NJ 970 4800
preplace netloc audio_codec_0_LRCLK 1 6 4 2840J 960 NJ 960 NJ 960 4900
preplace netloc audio_codec_0_MCLK 1 6 4 2850 1490 3450J 1580 4410J 1120 NJ
preplace netloc audio_codec_0_i2stxd 1 6 4 2830 1500 3440J 1590 4400J 1060 NJ
preplace netloc clk_wiz_0_clk_out2 1 1 7 310J 1370 630 1380 1060 1460 1760 1410 2180 1042 2880 1070 3410
preplace netloc clock_122_1 1 0 1 -260J 1350n
preplace netloc clock_122_in_n_1 1 0 1 -250J 1300n
preplace netloc clock_generator_clock_122_out 1 0 8 -230 1550 350 1360 640 1370 1070 1470 N 1470 2220 1022 2870 1022 3450
preplace netloc clock_generator_clock_122_out_ADC 1 0 2 -240 1560 260
preplace netloc clock_generator_pll_lock 1 1 3 360J 1350 N 1350 1040
preplace netloc clock_mon_1 1 2 2 650J 1360 1050
preplace netloc clock_monitor_0_LED 1 2 1 640 1490n
preplace netloc cw_key_1 1 5 2 2280 982 2720
preplace netloc is2rxd_1 1 0 6 NJ 740 N 740 N 740 N 740 1670 790 2150
preplace netloc keyer_config_1 1 4 2 1670 862 N
preplace netloc ref_in_10_1 1 0 2 -270J 1520 380
preplace netloc regmux_2_1_1_dout 1 6 4 2730J 240 N 240 N 240 N
preplace netloc reset_rtl_0_1 1 0 4 NJ 880 N 880 N 880 1020
preplace netloc status_in_1 1 0 6 NJ 550 N 550 N 550 N 550 1700 570 2130
preplace netloc tx_samples_1 1 5 2 2260 1052 2710
preplace netloc util_reduced_logic_0_Res 1 1 9 270 -220 N -220 N -220 N -220 N -220 NJ -220 N -220 N -220 N
preplace netloc util_reduced_logic_1_Res 1 5 5 2270 992 2730 460 N 460 N 460 4910
preplace netloc util_reduced_logic_2_Res 1 6 4 NJ 270 N 270 4370 310 4870
preplace netloc util_reduced_logic_3_Res 1 6 4 2740J 540 N 540 N 540 N
preplace netloc util_vector_logic_0_Res 1 3 7 990J -20 NJ -20 2240J 20 2830J 140 NJ 140 NJ 140 4880
preplace netloc xlslice_0_Dout 1 6 4 2730J 320 N 320 N 320 4880
preplace netloc xlslice_0_Dout1 1 5 1 2230 40n
preplace netloc xlslice_1_Dout1 1 5 2 2240 30 2760
preplace netloc xlslice_2_Dout 1 5 1 2070 310n
preplace netloc xlslice_3_Dout 1 5 1 2120 410n
preplace netloc xlslice_4_Dout 1 5 4 2190 1002 2820J 710 NJ 710 4370J
preplace netloc xlslice_5_Dout 1 6 4 NJ 230 N 230 N 230 4910
preplace netloc FIFO_Interfaces_M_AXIS_codec 1 5 4 2270 1550 NJ 1550 NJ 1550 4370
preplace netloc PCIe_M03_AXI_0 1 4 4 1540J -90 NJ -90 2880 60 3520
preplace netloc PCIe_M08_AXI_0 1 4 2 1610J 760 2130
preplace netloc PCIe_M09_AXI 1 4 2 N 990 2090
preplace netloc PCIe_M_AXI_Alex 1 4 2 1580 230 NJ
preplace netloc PCIe_M_AXI_full_0 1 4 4 NJ 930 2140J 1032 N 1032 3460
preplace netloc PCIe_SPI_0_0 1 4 6 NJ 950 2160J 952 2780J 680 N 680 4370 660 NJ
preplace netloc PCIe_pcie_7x_mgt_rtl_0 1 4 6 1560 -80 N -80 2870 70 N 70 N 70 N
preplace netloc Receiver_RX_Data 1 6 2 2870 1090 3460
preplace netloc S_AXIS_KeyerAmpl_1 1 5 3 2280 1080 NJ 1080 3430
preplace netloc S_AXIS_codec_1 1 6 2 2860 1110 NJ
preplace netloc TX_IQ_In_1 1 5 4 2250 1540 NJ 1540 N 1540 4380
preplace netloc Transmitter_m_axis_sidetoneampl 1 6 1 2740 722n
preplace netloc diff_clock_rtl_0_1 1 0 4 NJ 800 N 800 N 800 1030
preplace netloc s_axi_0_1 1 4 2 NJ 830 2130
preplace netloc s_axi_1_1 1 4 2 NJ 850 2110
...
levelinfo -pg 1 -320 70 520 810 1380 1960 2520 3282 4124 4630 4930
pagesize -pg 1 -db -bbox -sgen -490 -530 5120 5820
",
   "linecolor_comment_1":"",
...
if {[string equal [get_runs -quiet synth_2] ""]} {
    create_run -name synth_2 -part xc7a200tfbg676-2 -flow {Vivado Synthesis 2021} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "needs_refresh" -value "1" -objects $obj
set_property -name "part" -value "xc7a200tfbg676-2" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/saturn_project.srcs/utils_1/imports/synth_2/saturn_top_wrapper.dcp" -objects $obj
set_property -name "auto_incremental_checkpoint" -value "1" -objects $obj
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2021} -strategy "Performance_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if {[string equal [get_runs -quiet impl_3] ""]} {
    create_run -name impl_3 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2021} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
# Create 'impl_3_opt_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_3] impl_3_opt_report_utilization_0] "" ] } {
  create_report_config -report_name impl_3_opt_report_utilization_0 -report_type report_utilization:1.0 -steps opt_design -runs impl_3
}
set obj [get_report_configs -of_objects [get_runs impl_3] impl_3_opt_report_utilization_0]
if { $obj != "" } {

}
# Create 'impl_3_opt_report_methodology_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_3] impl_3_opt_report_methodology_0] "" ] } {
  create_report_config -report_name impl_3_opt_report_methodology_0 -report_type report_methodology:1.0 -steps opt_design -runs impl_3
}
set obj [get_report_configs -of_objects [get_runs impl_3] impl_3_opt_report_methodology_0]
if { $obj != "" } {
...
# Create 'impl_3_phys_opt_report_design_analysis_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_3] impl_3_phys_opt_report_design_analysis_0] "" ] } {
  create_report_config -report_name impl_3_phys_opt_report_design_analysis_0 -report_type report_design_analysis:1.0 -steps phys_opt_design -runs impl_3
}
set obj [get_report_configs -of_objects [get_runs impl_3] impl_3_phys_opt_report_design_analysis_0]
if { $obj != "" } {
set_property -name "options.congestion" -value "1" -objects $obj

}
# Create 'impl_3_route_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs impl_3] impl_3_route_report_utilization_0] "" ] } {
  create_report_config -report_name impl_3_route_report_utilization_0 -report_type report_utilization:1.0 -steps route_design -runs impl_3
}
set obj [get_report_configs -of_objects [get_runs impl_3] impl_3_route_report_utilization_0]
if { $obj != "" } {
...
if {[string equal [get_runs -quiet impl_4] ""]} {
    create_run -name impl_4 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2021} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
  set_property strategy "Performance_Explore" [get_runs impl_4]
