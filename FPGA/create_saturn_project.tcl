...
#
# Generated by Vivado on Mon Aug 15 13:08:27 +0100 2022
...
if { [get_files axi_stream_interleaver.v] == "" } {
  import_files -quiet -fileset sources_1 C:/xilinxdesigns/Saturn/FPGA/sources/verilogmodules/axi_stream_interleaver.v
}
if { [get_files axi_stream_resizer.v] == "" } {
  import_files -quiet -fileset sources_1 C:/xilinxdesigns/Saturn/FPGA/sources/verilogmodules/axi_stream_resizer.v
}
if { [get_files axi_stream_resizer.v] == "" } {
  import_files -quiet -fileset sources_1 C:/xilinxdesigns/Saturn/FPGA/sources/verilogmodules/axi_stream_resizer.v
}
...
# The design that will be created by this Tcl proc contains the following 
# module references:
# clock_monitor, D_register_norst, D_register_norst, D_register_norst, D_register_norst, LTC2208_derandomise, LTC2208_derandomise, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, AXI_Stream_Reader_Writer, FIFO_Monitor, FIFO_Monitor, FIFO_Monitor, FIFO_Monitor, AXIL_ConfigReg_256, AXIL_ConfigReg_64, AXIL_ReadReg_64, AXIL_ReadReg_64, AXI_ADC_overrange_reader, AXI_SPI_ADC, D_register, D_register, Double_D_register, Double_D_register, Usr_Reg_Access, AXILite_Alex_SPI, AXIL_ConfigReg_256, AXIL_ConfigReg_256, axis_constant, regmux_2_1, ClockDivider, ClockDivider, PWM_DAC, SerialAtten, SerialAtten, regmux_2_1, regmux_2_1, regmux_2_1, regmux_2_1, ClockDivider, debounce, debounce, debounce, debounce, debounce, debounce, debounce, debounce, AXIS_Interleaver, AXIS_Sizer_48to64, AXIS_Sizer_48to64, D_register, D_register, D_register, D_register, AXIS_Interleaver, AXIS_Sizer_48to64, AXIS_Sizer_48to64, D_register, D_register, D_register, D_register, AXIS_Interleaver, AXIS_Sizer_48to64, AXIS_Sizer_48to64, D_register, D_register, D_register, D_register, AXIS_Interleaver, AXIS_Sizer_48to64, AXIS_Sizer_48to64, D_register, D_register, D_register, D_register, AXIS_Interleaver, AXIS_Sizer_48to64, AXIS_Sizer_48to64, D_register, D_register, D_register, D_register, D_register, axis_variable, axis_variable
...
proc create_hier_cell_dualDDC98 { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 DDC_98_FIFO_aresetn
  ...
  connect_bd_net -net Net2 [get_bd_pins aresetn] [get_bd_pins AXIS_Interleaver_0/aresetn] [get_bd_pins AXIS_Sizer_48to64_0/aresetn] [get_bd_pins AXIS_Sizer_48to64_1/aresetn] [get_bd_pins DDC_Block_0/rstn] [get_bd_pins DDC_Block_1/rstn] [get_bd_pins D_register_0/resetn] [get_bd_pins D_register_1/resetn] [get_bd_pins D_register_2/resetn] [get_bd_pins D_register_3/resetn] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net Net3 [get_bd_pins DualDDCConfig] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_Arate/Din] [get_bd_pins xlslice_Asource/Din] [get_bd_pins xlslice_Brate/Din] [get_bd_pins xlslice_Bsource/Din] [get_bd_pins xlslice_enable/Din] [get_bd_pins xlslice_interleave/Din]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins DDC_98_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
  ...
  connect_bd_net -net xlslice_interleave_Dout [get_bd_pins AXIS_Interleaver_0/interleave] [get_bd_pins DDC_Block_1/LOIQSel] [get_bd_pins xlslice_interleave/Dout]
...
proc create_hier_cell_dualDDC76 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 31 -to 0 DDCAFreq
  create_bd_pin -dir I -from 31 -to 0 DDCBFreq
  create_bd_pin -dir O -from 0 -to 0 DDC_76_FIFO_aresetn
  create_bd_pin -dir I -from 31 -to 0 DualDDCConfig
  create_bd_pin -dir I -from 15 -to 0 RX_Test
  create_bd_pin -dir I -from 15 -to 0 TX_samples
  create_bd_pin -dir I aclk
  ...
  connect_bd_net -net test_source_1 [get_bd_pins DDC_Block_0/test_source] [get_bd_pins DDC_Block_1/test_source] [get_bd_pins D_register_3/dout]
  connect_bd_net -net tx_samples_1 [get_bd_pins DDC_Block_0/tx_samples] [get_bd_pins DDC_Block_1/tx_samples] [get_bd_pins D_register_2/dout]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins DDC_76_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DDC_Block_0/LOIQIn_tvalid] [get_bd_pins DDC_Block_0/LOIQSel] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_enable_Dout [get_bd_pins AXIS_Interleaver_0/enabled] [get_bd_pins xlslice_enable/Dout]
  connect_bd_net -net xlslice_interleave_Dout [get_bd_pins AXIS_Interleaver_0/interleave] [get_bd_pins DDC_Block_1/LOIQSel] [get_bd_pins xlslice_interleave/Dout]
...
proc create_hier_cell_dualDDC54 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 31 -to 0 DDCAFreq
  create_bd_pin -dir I -from 31 -to 0 DDCBFreq
  create_bd_pin -dir O -from 0 -to 0 DDC_54_FIFO_aresetn
  create_bd_pin -dir I -from 31 -to 0 DualDDCConfig
  create_bd_pin -dir I -from 15 -to 0 RX_Test
  create_bd_pin -dir I -from 15 -to 0 TX_samples
  create_bd_pin -dir I aclk
  ...
  connect_bd_net -net test_source_1 [get_bd_pins DDC_Block_0/test_source] [get_bd_pins DDC_Block_1/test_source] [get_bd_pins D_register_3/dout]
  connect_bd_net -net tx_samples_1 [get_bd_pins DDC_Block_0/tx_samples] [get_bd_pins DDC_Block_1/tx_samples] [get_bd_pins D_register_2/dout]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins DDC_54_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DDC_Block_0/LOIQIn_tvalid] [get_bd_pins DDC_Block_0/LOIQSel] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_1/Dout]
...
proc create_hier_cell_dualDDC32 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 31 -to 0 DDCAFreq
  create_bd_pin -dir I -from 31 -to 0 DDCBFreq
  create_bd_pin -dir O -from 0 -to 0 DDC_32_FIFO_aresetn
  create_bd_pin -dir I -from 31 -to 0 DualDDCConfig
  create_bd_pin -dir I -from 15 -to 0 RX_Test
  create_bd_pin -dir I -from 15 -to 0 TX_samples
  create_bd_pin -dir I aclk
  ...
  connect_bd_net -net test_source_1 [get_bd_pins DDC_Block_0/test_source] [get_bd_pins DDC_Block_1/test_source] [get_bd_pins D_register_3/dout]
  connect_bd_net -net tx_samples_1 [get_bd_pins DDC_Block_0/tx_samples] [get_bd_pins DDC_Block_1/tx_samples] [get_bd_pins D_register_2/dout]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins DDC_32_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DDC_Block_0/LOIQIn_tvalid] [get_bd_pins DDC_Block_0/LOIQSel] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_enable_Dout [get_bd_pins AXIS_Interleaver_0/enabled] [get_bd_pins xlslice_enable/Dout]
  connect_bd_net -net xlslice_interleave_Dout [get_bd_pins AXIS_Interleaver_0/interleave] [get_bd_pins DDC_Block_1/LOIQSel] [get_bd_pins xlslice_interleave/Dout]
...
proc create_hier_cell_dualDDC10 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 31 -to 0 DDCAFreq
  create_bd_pin -dir I -from 31 -to 0 DDCBFreq
  create_bd_pin -dir O -from 0 -to 0 DDC_10_FIFO_aresetn
  create_bd_pin -dir I -from 31 -to 0 DualDDCConfig
  create_bd_pin -dir I -from 15 -to 0 RX_Test
  create_bd_pin -dir I -from 15 -to 0 TX_samples
  create_bd_pin -dir I aclk
  ...
  connect_bd_net -net din_2_1 [get_bd_pins TX_samples] [get_bd_pins D_register_2/din]
  connect_bd_net -net din_3_1 [get_bd_pins RX_Test] [get_bd_pins D_register_3/din]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins DDC_10_FIFO_aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins DDC_Block_0/LOIQIn_tvalid] [get_bd_pins DDC_Block_0/LOIQSel] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_Receiver { parentCell nameHier } {
  ...
  if { [catch {set AXIL_ConfigReg_256_RX_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.INITIAL_VALUE_word_2 {262144} \
   CONFIG.INITIAL_VALUE_word_5 {262144} \
  ...
  if { [catch {set AXIL_ConfigReg_256_RX_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.INITIAL_VALUE_word_0 {262144} \
   CONFIG.INITIAL_VALUE_word_3 {262144} \
   CONFIG.INITIAL_VALUE_word_6 {262144} \
  ...
  connect_bd_net -net dualDDC10_DDC_10_FIFO_aresetn [get_bd_pins DDC_10_FIFO_aresetn] [get_bd_pins dualDDC10/DDC_10_FIFO_aresetn]
  connect_bd_net -net dualDDC32_DDC_32_FIFO_aresetn [get_bd_pins DDC_32_FIFO_aresetn] [get_bd_pins dualDDC32/DDC_32_FIFO_aresetn]
  connect_bd_net -net dualDDC54_DDC_54_FIFO_aresetn [get_bd_pins DDC_54_FIFO_aresetn] [get_bd_pins dualDDC54/DDC_54_FIFO_aresetn]
  connect_bd_net -net dualDDC76_DDC_76_FIFO_aresetn [get_bd_pins DDC_76_FIFO_aresetn] [get_bd_pins dualDDC76/DDC_76_FIFO_aresetn]
  connect_bd_net -net dualDDC98_DDC_98_FIFO_aresetn [get_bd_pins DDC_98_FIFO_aresetn] [get_bd_pins dualDDC98/DDC_98_FIFO_aresetn]
...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_lite_125_M07_AXI [get_bd_intf_pins AXIL_ReadReg_64_ID/s_axi] [get_bd_intf_pins axi_interconnect_lite_125/M07_AXI]
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins axi_aclk_125] [get_bd_pins AXIL_ConfigReg_64_0/aclk] [get_bd_pins AXIL_ReadReg_64_ID/aclk] [get_bd_pins axi_interconnect_lite/ACLK] [get_bd_pins axi_interconnect_lite/M00_ACLK] [get_bd_pins axi_interconnect_lite/S00_ACLK] [get_bd_pins axi_interconnect_lite_125/ACLK] [get_bd_pins axi_interconnect_lite_125/M00_ACLK] [get_bd_pins axi_interconnect_lite_125/M01_ACLK] [get_bd_pins axi_interconnect_lite_125/M02_ACLK] [get_bd_pins axi_interconnect_lite_125/M03_ACLK] [get_bd_pins axi_interconnect_lite_125/M04_ACLK] [get_bd_pins axi_interconnect_lite_125/M05_ACLK] [get_bd_pins axi_interconnect_lite_125/M06_ACLK] [get_bd_pins axi_interconnect_lite_125/M07_ACLK] [get_bd_pins axi_interconnect_lite_125/S00_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xdma_0/axi_aclk]
...
proc create_hier_cell_FIFO_Interfaces { parentCell nameHier } {
  ...
  create_bd_pin -dir I RX_FIFO_01_aresetn
  create_bd_pin -dir I RX_FIFO_32_aresetn
  create_bd_pin -dir I RX_FIFO_54_aresetn
  create_bd_pin -dir I RX_FIFO_76_aresetn
  create_bd_pin -dir I RX_FIFO_98_aresetn
  ...
  connect_bd_net -net Net [get_bd_pins RX_FIFO_98_aresetn] [get_bd_pins axis_data_fifo_DDC8/s_axis_aresetn] [get_bd_pins axis_data_fifo_DDC9/s_axis_aresetn]
  ...
  connect_bd_net -net Net2 [get_bd_pins RX_FIFO_01_aresetn] [get_bd_pins axis_data_fifo_DDC0/s_axis_aresetn] [get_bd_pins axis_data_fifo_DDC1/s_axis_aresetn]
  connect_bd_net -net Net3 [get_bd_pins RX_FIFO_32_aresetn] [get_bd_pins axis_data_fifo_DDC2/s_axis_aresetn] [get_bd_pins axis_data_fifo_DDC3/s_axis_aresetn]
  connect_bd_net -net Net4 [get_bd_pins RX_FIFO_76_aresetn] [get_bd_pins axis_data_fifo_DDC6/s_axis_aresetn] [get_bd_pins axis_data_fifo_DDC7/s_axis_aresetn]
  connect_bd_net -net Net5 [get_bd_pins RX_FIFO_54_aresetn] [get_bd_pins axis_data_fifo_DDC4/s_axis_aresetn] [get_bd_pins axis_data_fifo_DDC5/s_axis_aresetn]
...
proc create_hier_cell_ADC_LVDS_Pins { parentCell nameHier } {
  ...
  connect_bd_net -net Receiver_DDC_10_FIFO_aresetn [get_bd_pins FIFO_Interfaces/RX_FIFO_01_aresetn] [get_bd_pins Receiver/DDC_10_FIFO_aresetn]
  connect_bd_net -net Receiver_DDC_32_FIFO_aresetn [get_bd_pins FIFO_Interfaces/RX_FIFO_32_aresetn] [get_bd_pins Receiver/DDC_32_FIFO_aresetn]
  connect_bd_net -net Receiver_DDC_54_FIFO_aresetn [get_bd_pins FIFO_Interfaces/RX_FIFO_54_aresetn] [get_bd_pins Receiver/DDC_54_FIFO_aresetn]
  connect_bd_net -net Receiver_DDC_76_FIFO_aresetn [get_bd_pins FIFO_Interfaces/RX_FIFO_76_aresetn] [get_bd_pins Receiver/DDC_76_FIFO_aresetn]
  connect_bd_net -net Receiver_DDC_98_FIFO_aresetn [get_bd_pins FIFO_Interfaces/RX_FIFO_98_aresetn] [get_bd_pins Receiver/DDC_98_FIFO_aresetn]
  ...
  assign_bd_address -offset 0x00006000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI_LITE] [get_bd_addr_segs FIFO_Interfaces/FIFO_Monitor_0/s_axi/reg0] -force
  assign_bd_address -offset 0x00007000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI_LITE] [get_bd_addr_segs FIFO_Interfaces/FIFO_Monitor_1/s_axi/reg0] -force
  assign_bd_address -offset 0x00008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI_LITE] [get_bd_addr_segs FIFO_Interfaces/FIFO_Monitor_2/s_axi/reg0] -force
  assign_bd_address -offset 0x00009000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI_LITE] [get_bd_addr_segs FIFO_Interfaces/FIFO_Monitor_3/s_axi/reg0] -force
...
#  -string -flagsOSRD
preplace port PROM_SPI -pg 1 -lvl 10 -x 4750 -y 660 -defaultsOSRD
preplace port iic_rtl_0 -pg 1 -lvl 10 -x 4750 -y 100 -defaultsOSRD
preplace port pcie_7x_mgt_rtl_0 -pg 1 -lvl 10 -x 4750 -y 70 -defaultsOSRD
...
preplace port port-id_ADC1_ATTEN_CLK -pg 1 -lvl 10 -x 4750 -y -190 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_DAT -pg 1 -lvl 10 -x 4750 -y -160 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_LE -pg 1 -lvl 10 -x 4750 -y -130 -defaultsOSRD
...
preplace port port-id_ADC2_ATTEN_CLK -pg 1 -lvl 10 -x 4750 -y -100 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_DAT -pg 1 -lvl 10 -x 4750 -y -70 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_LE -pg 1 -lvl 10 -x 4750 -y -40 -defaultsOSRD
...
preplace port port-id_BCLK -pg 1 -lvl 10 -x 4750 -y 990 -defaultsOSRD
...
preplace port port-id_CTRL_TRSW -pg 1 -lvl 10 -x 4750 -y 510 -defaultsOSRD
preplace port port-id_DRIVER_PA_EN -pg 1 -lvl 10 -x 4750 -y 420 -defaultsOSRD
preplace port port-id_EMC_CLK -pg 1 -lvl 0 -x -320 -y 580 -defaultsOSRD
preplace port port-id_LRCLK -pg 1 -lvl 10 -x 4750 -y 950 -defaultsOSRD
preplace port port-id_MCLK -pg 1 -lvl 10 -x 4750 -y 1120 -defaultsOSRD
preplace port port-id_MOX_strobe -pg 1 -lvl 10 -x 4750 -y 480 -defaultsOSRD
...
preplace port port-id_RF_SPI_CK -pg 1 -lvl 10 -x 4750 -y 570 -defaultsOSRD
preplace port port-id_RF_SPI_DATA -pg 1 -lvl 10 -x 4750 -y 600 -defaultsOSRD
preplace port port-id_RF_SPI_RX_LOAD -pg 1 -lvl 10 -x 4750 -y 630 -defaultsOSRD
preplace port port-id_RF_SPI_TX_LOAD -pg 1 -lvl 10 -x 4750 -y 690 -defaultsOSRD
preplace port port-id_TX_DAC_PWM -pg 1 -lvl 10 -x 4750 -y 720 -defaultsOSRD
...
preplace port port-id_i2stxd -pg 1 -lvl 10 -x 4750 -y 1060 -defaultsOSRD
preplace port port-id_pcie_reset_n -pg 1 -lvl 0 -x -320 -y 880 -defaultsOSRD
preplace port port-id_pll_cr -pg 1 -lvl 10 -x 4750 -y -220 -defaultsOSRD
...
preplace portBus ADC_CLK -pg 1 -lvl 10 -x 4750 -y 1420 -defaultsOSRD
preplace portBus ADC_MOSI -pg 1 -lvl 10 -x 4750 -y 1450 -defaultsOSRD
preplace portBus ATU_TUNE -pg 1 -lvl 10 -x 4750 -y 210 -defaultsOSRD
preplace portBus BLINK_LED -pg 1 -lvl 10 -x 4750 -y -10 -defaultsOSRD
preplace portBus BUF_Out_FPGA -pg 1 -lvl 10 -x 4750 -y 450 -defaultsOSRD
preplace portBus DAC_Out_N -pg 1 -lvl 10 -x 4750 -y 770 -defaultsOSRD
preplace portBus DAC_Out_P -pg 1 -lvl 10 -x 4750 -y 800 -defaultsOSRD
preplace portBus Dac_Atten -pg 1 -lvl 10 -x 4750 -y 240 -defaultsOSRD
preplace portBus Dac_Atten_Clk -pg 1 -lvl 10 -x 4750 -y 390 -defaultsOSRD
preplace portBus Dac_Atten_Data -pg 1 -lvl 10 -x 4750 -y 360 -defaultsOSRD
preplace portBus Dac_Atten_LE -pg 1 -lvl 10 -x 4750 -y 300 -defaultsOSRD
preplace portBus Dac_Atten_Mode -pg 1 -lvl 10 -x 4750 -y 330 -defaultsOSRD
preplace portBus FPGA_CM4_EN -pg 1 -lvl 10 -x 4750 -y 1390 -defaultsOSRD
preplace portBus GPIO_OUT -pg 1 -lvl 10 -x 4750 -y 270 -defaultsOSRD
preplace portBus LEDOutputs -pg 1 -lvl 10 -x 4750 -y 40 -defaultsOSRD
preplace portBus PCIECLKREQN -pg 1 -lvl 10 -x 4750 -y 1090 -defaultsOSRD
preplace portBus PCI_LINK_LED -pg 1 -lvl 10 -x 4750 -y 1510 -defaultsOSRD
preplace portBus TXRX_RELAY -pg 1 -lvl 10 -x 4750 -y 540 -defaultsOSRD
preplace portBus nADC_CS -pg 1 -lvl 10 -x 4750 -y 1480 -defaultsOSRD
...
preplace inst DAC_LVDS_Pins -pg 1 -lvl 9 -x 4463 -y 820 -defaultsOSRD
preplace inst FIFO_Interfaces -pg 1 -lvl 8 -x 3964 -y 1260 -defaultsOSRD -resize 448 539
preplace inst PCIe -pg 1 -lvl 4 -x 1220 -y 1120 -defaultsOSRD
preplace inst RF_interfaces -pg 1 -lvl 6 -x 2360 -y 330 -defaultsOSRD
preplace inst Receiver -pg 1 -lvl 6 -x 2360 -y 2000 -defaultsOSRD
preplace inst Transmitter -pg 1 -lvl 6 -x 2360 -y 782 -defaultsOSRD
preplace inst audio_codec_0 -pg 1 -lvl 6 -x 2360 -y 1310 -defaultsOSRD
preplace inst axis_clock_cvt_sidetone_122_to_12 -pg 1 -lvl 7 -x 3122 -y 820 -defaultsOSRD
preplace inst clock_generator -pg 1 -lvl 1 -x 70 -y 1410 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 5 -x 1690 -y 40 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 5 -x 1690 -y 160 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 5 -x 1690 -y 310 -defaultsOSRD
preplace inst xlslice_3 -pg 1 -lvl 5 -x 1690 -y 410 -defaultsOSRD
preplace inst xlslice_4 -pg 1 -lvl 5 -x 1690 -y 510 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 3 -x 800 -y 1550 -defaultsOSRD
preplace inst clock_monitor_0 -pg 1 -lvl 2 -x 510 -y 1480 -defaultsOSRD
...
preplace netloc ADC1_Overrange_1 1 1 3 NJ 1100 N 1100 950
...
preplace netloc ADC_Ctrl_1 1 4 2 1460 250 N
preplace netloc ADC_LVDS_Pins_ADC1_SingleEnded 1 1 5 340 1330 N 1330 1000 1480 N 1480 1800
preplace netloc ADC_LVDS_Pins_ADC2_SingleEnded 1 1 5 290 1340 N 1340 950 1490 N 1490 1790
preplace netloc ADC_MISO_0_1 1 0 4 -280J 1510 300J 1300 NJ 1300 980
preplace netloc BUFF_Alex_Pin1_0_1 1 0 6 NJ 610 NJ 610 NJ 610 950 600 NJ 600 1790J
preplace netloc BUFF_Alex_Pin8_0_1 1 0 6 NJ 640 NJ 640 NJ 640 960 610 NJ 610 1820J
preplace netloc CodecConfig_1 1 4 2 N 1120 1790
preplace netloc DAC_Ctrl_1 1 4 2 1480 580 1810
preplace netloc DAC_LVDS_Pins_DAC_Out_N 1 9 1 4660 770n
preplace netloc DAC_LVDS_Pins_DAC_Out_P 1 9 1 4720 800n
preplace netloc DAC_SingleEnded_1 1 6 3 2580 700 N 700 4220
preplace netloc EMC_CLK_1 1 0 2 N 580 320
preplace netloc PCIe_ADC_CLK 1 4 6 NJ 1080 NJ 1080 2560J 1127 3320 1560 4240 1420 NJ
preplace netloc PCIe_ADC_MOSI 1 4 6 NJ 1100 NJ 1100 2540J 1107 3340 1570 4260 1450 NJ
preplace netloc PCIe_FPGA_CM4_EN 1 4 6 1530J 1159 NJ 1159 NJ 1159 3300 1580 4250 1390 NJ
preplace netloc PCIe_LEDDrivers 1 4 6 1470 -30 N -30 2670J 140 N 140 N 140 4720J
preplace netloc PCIe_PCIECLKREQN 1 4 6 1560J 1179 NJ 1179 NJ 1179 3290 1590 4230 1090 NJ
preplace netloc PCIe_PCI_LINK_LED 1 4 6 1580 1200 NJ 1200 2540J 1209 3280 1600 4300 1510 NJ
preplace netloc PCIe_RFGPIOData 1 4 2 1500 590 1830
preplace netloc PCIe_TXTestFreqData 1 4 2 1570 800 1920
preplace netloc PCIe_T_SMBCLK_0_1 1 0 4 -300J 1560 350J 1310 NJ 1310 990
preplace netloc PCIe_T_SMBDAT_0_1 1 0 4 -290J 1550 360J 1320 NJ 1320 1010
preplace netloc PCIe_aresetn12 1 4 4 1590J 1012 1960J 1012 2630 1017 3370
preplace netloc PCIe_axi_aclk_125 1 1 7 380 1620 N 1620 1040 1520 1460J 1420 NJ 1420 2750 1337 N
preplace netloc PCIe_axi_resetn 1 4 1 1510 40n
preplace netloc PCIe_nADC_CS 1 4 6 1430J 1430 1790J 1460 2530J 1490 3260 1610 4290 1480 NJ
preplace netloc PWM_DAC_0_DAC_bit 1 6 4 2620J 530 N 530 N 530 4630
preplace netloc RF_interfaces_BUF_Out_FPGA 1 6 4 NJ 250 N 250 4300 300 4700J
preplace netloc RF_interfaces_Dac_Atten_Clk 1 6 4 2530J 340 N 340 4300 350 4690J
preplace netloc RF_interfaces_Dac_Atten_Data 1 6 4 NJ 350 N 350 4210 360 NJ
preplace netloc RF_interfaces_Dac_Atten_LE 1 6 4 2580J 330 N 330 N 330 4720J
preplace netloc RF_interfaces_Dac_Atten_Mode 1 6 4 NJ 390 N 390 4210 370 4730J
preplace netloc RF_interfaces_status_out 1 3 4 1050 -60 N -60 N -60 2560
preplace netloc Receiver_DDC_10_FIFO_aresetn 1 6 2 2800J 1480 3380
preplace netloc Receiver_DDC_32_FIFO_aresetn 1 6 2 2810 1500 3400J
preplace netloc Receiver_DDC_54_FIFO_aresetn 1 6 2 2820J 1510 3410
preplace netloc Receiver_DDC_76_FIFO_aresetn 1 6 2 2830J 1520 3420
preplace netloc Receiver_DDC_98_FIFO_aresetn 1 6 2 2840J 1530 3430
preplace netloc SPI_0_Rx_load_strobe 1 6 4 NJ 490 N 490 N 490 4650
preplace netloc SPI_0_SPI_clock 1 6 4 NJ 450 N 450 N 450 4670
preplace netloc SPI_0_SPI_data 1 6 4 NJ 470 N 470 N 470 4660
preplace netloc SPI_0_Tx_load_strobe 1 6 4 NJ 510 N 510 N 510 4640
preplace netloc SerialAtten_0_ATTN_CLK 1 6 4 2570J -120 N -120 N -120 4630
preplace netloc SerialAtten_0_ATTN_DATA 1 6 4 2580J -110 N -110 N -110 4640
preplace netloc SerialAtten_0_ATTN_LE 1 6 4 2590J 50 N 50 4290 60 4660
preplace netloc SerialAtten_1_ATTN_CLK 1 6 4 2610J 80 N 80 N 80 4670
preplace netloc SerialAtten_1_ATTN_DATA 1 6 4 2620J 100 N 100 N 100 4680
preplace netloc SerialAtten_1_ATTN_LE 1 6 4 2630J 110 N 110 N 110 4700
preplace netloc TXConfig_1 1 4 2 1540 770 1910
preplace netloc TXLOTune_1 1 4 2 1550 780 1790
preplace netloc TX_ENABLE_0_1 1 0 6 NJ 770 NJ 770 N 770 1040 760 1390J 810 1910J
preplace netloc Transmitter_TX_FIFO_aresetn 1 6 2 2610J 720 3380
preplace netloc Transmitter_cw_ptt1 1 5 2 1990 962 2530
preplace netloc aclk_1 1 1 8 280 -50 NJ -50 N -50 NJ -50 NJ -50 2710J 120 NJ 120 4230J
preplace netloc adcrand_1 1 0 7 -230 -20 NJ -20 NJ -20 N -20 NJ -20 NJ -20 2540
preplace netloc aresetn_125_1 1 1 7 390 1610 N 1610 1010 1510 1420J 1470 NJ 1470 N 1470 3360
preplace netloc audio_codec_0_BCLK 1 6 4 2670J 970 NJ 970 NJ 970 4680
preplace netloc audio_codec_0_LRCLK 1 6 4 2660J 960 NJ 960 NJ 960 4680
preplace netloc audio_codec_0_MCLK 1 6 4 2580 1450 3270J 1620 4280J 1120 NJ
preplace netloc audio_codec_0_i2stxd 1 6 4 2550 1460 3250J 1630 4270J 1060 NJ
preplace netloc clk_wiz_0_clk_out2 1 1 7 310J 1370 630 1380 1050 1470 1400 1410 1930 1022 2640 1007 3390
preplace netloc clock_122_1 1 0 1 -260J 1350n
preplace netloc clock_122_in_n_1 1 0 1 -250J 1300n
preplace netloc clock_generator_clock_122_out 1 0 8 -230 1530 330 1360 640 1370 1040 1500 N 1500 1940 1042 2650 1027 3360
preplace netloc clock_generator_clock_122_out_ADC 1 0 2 -240 1540 260
preplace netloc clock_generator_pll_lock 1 1 3 340J 1350 N 1350 1020
preplace netloc clock_mon_1 1 2 2 650J 1360 1030
preplace netloc clock_monitor_0_LED 1 2 1 640 1490n
preplace netloc cw_key_1 1 5 2 2010 952 2540
preplace netloc is2rxd_1 1 0 6 NJ 740 N 740 N 740 N 740 1490 790 1900
preplace netloc keyer_config_1 1 4 2 1520 862 N
preplace netloc ref_in_10_1 1 0 2 -270J 1520 370
preplace netloc regmux_2_1_1_dout 1 6 4 2590J 240 N 240 N 240 N
preplace netloc reset_rtl_0_1 1 0 4 NJ 880 N 880 N 880 1000
preplace netloc status_in_1 1 0 6 NJ 550 N 550 N 550 N 550 1550 570 1840
preplace netloc tx_samples_1 1 5 2 1970 20 2550
preplace netloc util_reduced_logic_0_Res 1 1 9 270 -220 N -220 N -220 N -220 N -220 NJ -220 N -220 N -220 N
preplace netloc util_reduced_logic_1_Res 1 5 5 2000 972 2570 460 N 460 N 460 4730
preplace netloc util_reduced_logic_2_Res 1 6 4 NJ 270 N 270 4290 310 4680
preplace netloc util_reduced_logic_3_Res 1 6 4 2590J 540 N 540 N 540 N
preplace netloc util_vector_logic_0_Res 1 3 7 970J -40 NJ -40 NJ -40 2680J 130 NJ 130 NJ 130 4710
preplace netloc xlslice_0_Dout 1 6 4 2570J 320 N 320 N 320 4710
preplace netloc xlslice_0_Dout1 1 5 3 1950 10 2660 150 3400
preplace netloc xlslice_1_Dout1 1 5 2 1960 30 2650
preplace netloc xlslice_2_Dout 1 5 1 1800 310n
preplace netloc xlslice_3_Dout 1 5 1 1850 410n
preplace netloc xlslice_4_Dout 1 5 4 1950 992 2620J 710 NJ 710 4210J
preplace netloc xlslice_5_Dout 1 6 4 NJ 230 N 230 N 230 4680
preplace netloc FIFO_Interfaces_M_AXIS_codec 1 5 4 2000 1550 NJ 1550 NJ 1550 4210
preplace netloc PCIe_M03_AXI_0 1 4 4 1400J -90 NJ -90 2800 60 3430
preplace netloc PCIe_M05_AXI_0 1 4 4 1420J -70 NJ -70 2730 90 3420
preplace netloc PCIe_M08_AXI_0 1 4 2 1450J 760 1900
preplace netloc PCIe_M_AXI_Alex 1 4 2 1440 230 NJ
preplace netloc PCIe_M_AXI_full_0 1 4 4 NJ 980 1920J 982 N 982 3410
preplace netloc PCIe_SPI_0_0 1 4 6 NJ 1000 1870J 1002 2590J 690 N 690 4210 660 NJ
preplace netloc PCIe_iic_rtl_0 1 4 6 1410J -100 NJ -100 NJ -100 N -100 4300 50 4730J
preplace netloc PCIe_pcie_7x_mgt_rtl_0 1 4 6 1430 -80 N -80 2790 70 N 70 N 70 N
preplace netloc Receiver_m_axis_DDC0 1 6 2 2680 1047 3310
preplace netloc Receiver_m_axis_DDC1 1 6 2 2690 1077 3320
preplace netloc Receiver_m_axis_DDC2 1 6 2 2700 1087 3340
preplace netloc Receiver_m_axis_DDC3 1 6 2 2710 1097 N
preplace netloc Receiver_m_axis_DDC4 1 6 2 2730 1117 3350
preplace netloc Receiver_m_axis_DDC5 1 6 2 2740 1137 3330
preplace netloc Receiver_m_axis_DDC6 1 6 2 2760 1148 N
preplace netloc Receiver_m_axis_DDC7 1 6 2 2770 1169 3350
preplace netloc Receiver_m_axis_DDC8 1 6 2 2780 1189 3350
preplace netloc Receiver_m_axis_DDC9 1 6 2 2790 1199 N
preplace netloc S_AXIS_KeyerAmpl_1 1 5 3 2010 1067 NJ 1067 3300
preplace netloc S_AXIS_codec_1 1 6 2 2720 1219 3350J
preplace netloc TX_IQ_In_1 1 5 4 1980 1540 NJ 1540 N 1540 4220
preplace netloc Transmitter_m_axis_sidetoneampl 1 6 1 2600 722n
preplace netloc diff_clock_rtl_0_1 1 0 4 NJ 800 N 800 N 800 1010
preplace netloc s_axi_0_1 1 4 2 NJ 820 1860
preplace netloc s_axi_1_1 1 4 2 NJ 840 1820
preplace netloc s_axi_lite_1_1 1 4 4 NJ 880 1890J 1052 2540 1057 3310
preplace netloc s_axi_lite_3_1 1 4 4 NJ 920 1880J 1032 2540 1037 3250
...
levelinfo -pg 1 -320 70 510 800 1220 1690 2360 3122 3964 4463 4750
pagesize -pg 1 -db -bbox -sgen -510 -530 4940 5820
",
   "linecolor_comment_1":"",
