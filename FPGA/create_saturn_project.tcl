...
#
# Generated by Vivado on Wed Apr 12 19:49:22 +0100 2023
...
# module references:
# Double_D_register, LFSR_Random_Number_Generator, axis_mux_2, axis_variable, axis_variable, byteswap_48, reg_to_axis, reg_to_axis, regmux_4_1, regmux_8_1
...
Data_Path_Fanout,Pre-Adder_Pipeline,Coefficient_Fanout,Control_Path_Fanout,Control_Column_Fanout,Control_Broadcast_Fanout,Control_LUT_Pipeline,No_BRAM_Read_First_Mode,Optimal_Column_Lengths,Other} \
  ...
  connect_bd_net -net rstn_1 [get_bd_ports rstn] [get_bd_pins LFSR_Random_Number_G_0/aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_mux_2_0/rstn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins axis_variable_0/aresetn] [get_bd_pins axis_variable_1/aresetn] [get_bd_pins byteswap_48_0/aresetn] [get_bd_pins cic_compiler_0/aresetn] [get_bd_pins cic_compiler_1/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins regmux_4_1_0/resetn] [get_bd_pins regmux_8_1_0/resetn]
