...
#
# Generated by Vivado on Fri Oct 27 08:26:32 +0100 2023
...
# D_register, axis_constant, axis_variable, axis_variable, cvt_offset_binary, regmux_2_1
  ...
  connect_bd_net -net Net5 [get_bd_ports clk122] [get_bd_pins D_register_2/aclk] [get_bd_pins axis_constant_0/aclk] [get_bd_pins axis_variable_0/aclk] [get_bd_pins axis_variable_1/aclk] [get_bd_pins cvt_offset_binary_0/clk] [get_bd_pins regmux_2_1_0/aclk] [get_bd_pins axis_broadcaster_cic_path_split/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_fir_to_IQ/aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins cic_compiler_1/aclk] [get_bd_pins cmpy_0/aclk] [get_bd_pins dds_compiler_txfreq/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins mult_gen_0/CLK]
...
# The design that will be created by this Tcl proc contains the following 
# module references:
# AXIS_Deinterleaver, axis_constant, axis_mux_4, cw_key_ramp, reg_to_axis, byteswap_48
  ...
  connect_bd_net -net Net1 [get_bd_ports clk122] [get_bd_pins AXIS_Deinterleaver_0/aclk] [get_bd_pins axis_constant_1/aclk] [get_bd_pins axis_mux_4_0/clk] [get_bd_pins cw_key_ramp_0/aclk] [get_bd_pins reg_to_axis_0/aclk] [get_bd_pins byteswap_48_0/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_subset_converter_32to48bit/aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins dds_compiler_testsource/aclk]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins AXIS_Deinterleaver_0/aresetn] [get_bd_pins axis_mux_4_0/rstn] [get_bd_pins cw_key_ramp_0/aresetn] [get_bd_pins byteswap_48_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_subset_converter_32to48bit/aresetn] [get_bd_pins dds_compiler_testsource/aresetn]
...
proc create_hier_cell_Strobes { parentCell nameHier } {
  ...
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins util_reduced_logic_1/Res] [get_bd_pins MOX_strobe] [get_bd_pins xlconcat_2/In1] [get_bd_pins xlconcat_3/In1]
...
proc create_hier_cell_RF_interfaces { parentCell nameHier } {
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins AXILite_Alex_SPI_0/aclk] [get_bd_pins AttenDrivers/clk122]
  ...
  connect_bd_net -net rstn_1 [get_bd_pins rstn] [get_bd_pins AttenDrivers/rstn] [get_bd_pins debounce/rstn] [get_bd_pins AXILite_Alex_SPI_0/aresetn]
  connect_bd_net -net status_in_1 [get_bd_pins status_in] [get_bd_pins debounce/status_in]
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins Strobes/MOX_strobe] [get_bd_pins MOX_strobe] [get_bd_pins AttenDrivers/tx_strobe]
  connect_bd_net -net util_reduced_logic_2_Res [get_bd_pins Strobes/CTRL_TRSW] [get_bd_pins CTRL_TRSW]
  connect_bd_net -net util_reduced_logic_3_Res [get_bd_pins Strobes/TXRX_RELAY] [get_bd_pins AXILite_Alex_SPI_0/TX_Strobe] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins xdma_0/axi_aclk] [get_bd_pins axi_aclk_125] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins AXIL_ConfigReg_64_0/aclk] [get_bd_pins AXIL_ReadReg_64_ID/aclk] [get_bd_pins axi_interconnect_lite/ACLK] [get_bd_pins axi_interconnect_lite/S00_ACLK] [get_bd_pins axi_interconnect_lite/M00_ACLK] [get_bd_pins axi_interconnect_lite_125/ACLK] [get_bd_pins axi_interconnect_lite_125/S00_ACLK] [get_bd_pins axi_interconnect_lite_125/M00_ACLK] [get_bd_pins axi_interconnect_lite_125/M01_ACLK] [get_bd_pins axi_interconnect_lite_125/M02_ACLK] [get_bd_pins axi_interconnect_lite_125/M03_ACLK] [get_bd_pins axi_interconnect_lite_125/M04_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk]
  ...
  connect_bd_net -net xlconstant_productversion_dout [get_bd_pins xlconstant_productversion/dout] [get_bd_pins xlconcat_1/In0]
...
proc create_hier_cell_ADC_LVDS_Pins { parentCell nameHier } {
  ...
  connect_bd_net -net util_reduced_logic_1_Res [get_bd_pins RF_interfaces/MOX_strobe] [get_bd_ports DRIVER_PA_EN] [get_bd_ports MOX_strobe] [get_bd_pins Transmitter/TXStrobe]
...
if {[string equal [get_runs -quiet impl_1_copy_1] ""]} {
    create_run -name impl_1_copy_1 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2023} -strategy "Performance_Retiming" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2_copy_1
} else {
  set_property strategy "Performance_Retiming" [get_runs impl_1_copy_1]
