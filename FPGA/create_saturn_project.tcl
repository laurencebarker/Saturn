...
#
# Generated by Vivado on Sat Nov 05 21:46:02 +0000 2022
...
Data_Path_Fanout,Pre-Adder_Pipeline,Coefficient_Fanout,Control_Path_Fanout,Control_Column_Fanout,Control_Broadcast_Fanout,Control_LUT_Pipeline,No_BRAM_Read_First_Mode,Optimal_Column_Lengths,Other} \
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins axis_subset_converter_0/M_AXIS] [get_bd_intf_pins byteswap_48_0/s_axis]
  ...
  connect_bd_net -net aclk_1 [get_bd_ports aclk] [get_bd_pins Double_D_register_0/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_mux_2_0/clk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_variable_0/aclk] [get_bd_pins axis_variable_1/aclk] [get_bd_pins byteswap_48_0/aclk] [get_bd_pins cic_compiler_0/aclk] [get_bd_pins cic_compiler_1/aclk] [get_bd_pins cmpy_0/aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins reg_to_axis_0/aclk] [get_bd_pins reg_to_axis_1/aclk] [get_bd_pins regmux_4_1_0/aclk] [get_bd_pins regmux_8_1_0/aclk]
  ...
  connect_bd_net -net rstn_1 [get_bd_ports rstn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_mux_2_0/rstn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_variable_0/aresetn] [get_bd_pins axis_variable_1/aresetn] [get_bd_pins byteswap_48_0/aresetn] [get_bd_pins cic_compiler_0/aresetn] [get_bd_pins cic_compiler_1/aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins fir_compiler_0/aresetn] [get_bd_pins regmux_4_1_0/resetn] [get_bd_pins regmux_8_1_0/resetn]
...
# I2S_rcv, I2S_xmit, axis_adder, axis_adder, axis_constant, axis_constant, axis_multiplier, axis_multiplier, byteswap_32, byteswap_32, i2s_clk_lrclk_gen
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_64to32bit_M_AXIS [get_bd_intf_pins axis_dwidth_converter_64to32bit/M_AXIS] [get_bd_intf_pins byteswap_32_0/s_axis]
  ...
  connect_bd_net -net arstn_1 [get_bd_ports arstn] [get_bd_pins I2S_rcv_0/resetn] [get_bd_pins I2S_xmit_0/resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins axis_dwidth_converter_64to32bit/aresetn] [get_bd_pins axis_multiplier_vol_star_sine/aresetn] [get_bd_pins axis_multiplier_vol_star_sine_star_ramp/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins byteswap_32_0/aresetn] [get_bd_pins byteswap_32_1/aresetn] [get_bd_pins i2s_clk_lrclk_gen_0/resetn]
...
# The design that will be created by this Tcl proc contains the following 
# module references:
# AXIS_Deinterleaver, AXIS_Sizer_64to48, axis_constant, axis_mux_4, byteswap_48, cw_key_ramp, reg_to_axis
  ...
  connect_bd_intf_net -intf_net AXIS_Sizer_64to48_0_m_axis [get_bd_intf_pins AXIS_Sizer_64to48_0/m_axis] [get_bd_intf_pins byteswap_48_0/s_axis]
  ...
  connect_bd_net -net resetn_1 [get_bd_ports resetn] [get_bd_pins AXIS_Deinterleaver_0/aresetn] [get_bd_pins AXIS_Sizer_64to48_0/aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_mux_4_0/rstn] [get_bd_pins axis_subset_converter_32to48bit/aresetn] [get_bd_pins byteswap_48_0/aresetn] [get_bd_pins cw_key_ramp_0/aresetn] [get_bd_pins dds_compiler_testsource/aresetn]
...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  connect_bd_net -net Double_D_register_syncareset1_dout [get_bd_pins aresetn12] [get_bd_pins Double_D_register_syncareset1/dout] [get_bd_pins util_vector_logic_2/Op2] [get_bd_pins util_vector_logic_3/Op2]
  connect_bd_net -net Net [get_bd_pins AXIL_ConfigReg_64_1/config_reg0] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din]
...
preplace port port-id_CODEC_CS -pg 1 -lvl 10 -x 4930 -y 1240 -defaultsOSRD
...
preplace inst Receiver -pg 1 -lvl 6 -x 2520 -y 1730 -defaultsOSRD
preplace inst Transmitter -pg 1 -lvl 6 -x 2520 -y 790 -defaultsOSRD
...
preplace netloc Byteswap_1 1 4 2 N 1390 2240
preplace netloc CodecConfig_1 1 4 2 N 1030 2100
preplace netloc DAC_Ctrl_1 1 4 2 1630 580 2080
preplace netloc DAC_LVDS_Pins_DAC_Out_N 1 9 1 4860 770n
preplace netloc DAC_LVDS_Pins_DAC_Out_P 1 9 1 4880 800n
preplace netloc DAC_SingleEnded_1 1 6 3 2760 700 N 700 4380
preplace netloc EMC_CLK_1 1 0 2 N 580 330
preplace netloc PCIe_ADC_CLK 1 4 6 1570J -70 NJ -70 2820J 140 N 140 N 140 4890J
preplace netloc PCIe_ADC_MOSI 1 4 6 1590J -30 NJ -30 2810J 180 N 180 N 180 4830J
preplace netloc PCIe_FPGA_CM4_EN 1 4 6 NJ 1070 NJ 1070 2720J 1090 3490 1600 4440 1390 NJ
preplace netloc PCIe_LEDDrivers 1 4 6 1620 -20 2060 10 2800J 190 N 190 N 190 4880J
preplace netloc PCIe_PCIECLKREQN 1 4 6 1560J 1140 NJ 1140 NJ 1140 3500 1560 4390 1090 NJ
preplace netloc PCIe_PCI_LINK_LED 1 4 6 N 1150 NJ 1150 NJ 1150 3480 1570 4430 1510 NJ
preplace netloc PCIe_RFGPIOData 1 4 2 1640 590 2100
preplace netloc PCIe_TXTestFreqData 1 4 2 1690 780 2200
...
preplace netloc PCIe_aresetn12 1 4 4 1700J 1040 2230J 1040 2850 1050 3520
preplace netloc PCIe_axi_aclk_125 1 1 7 380 1620 N 1620 1070 1530 1560J 1440 NJ 1440 2860 1260 N
preplace netloc PCIe_axi_resetn 1 4 1 1650 40n
preplace netloc PCIe_codec_cs 1 4 6 1730J 1160 NJ 1160 NJ 1160 3460J 1580 4420J 1380 4880
preplace netloc PCIe_codecspiclk 1 4 6 1710J 1170 NJ 1170 NJ 1170 3430J 1640 NJ 1640 NJ
preplace netloc PCIe_codecspidata 1 4 6 1740J 1180 NJ 1180 NJ 1180 3440J 1620 NJ 1620 NJ
preplace netloc PCIe_nADC_CS 1 4 6 NJ 1330 2080J 1430 2750J 1480 3410 1630 4450 1480 NJ
preplace netloc PWM_DAC_0_DAC_bit 1 6 4 2760J 530 N 530 N 530 4790
preplace netloc RF_interfaces_BUF_Out_FPGA 1 6 4 NJ 250 N 250 4450 300 4870J
preplace netloc RF_interfaces_Dac_Atten_Clk 1 6 4 2700J 340 N 340 4450 350 4860J
preplace netloc RF_interfaces_Dac_Atten_Data 1 6 4 NJ 350 N 350 4370 360 NJ
preplace netloc RF_interfaces_Dac_Atten_LE 1 6 4 2760J 330 N 330 N 330 4880J
preplace netloc RF_interfaces_Dac_Atten_Mode 1 6 4 NJ 390 N 390 4370 370 4890J
preplace netloc RF_interfaces_status_out 1 3 4 1070 -60 N -60 N -60 2730
preplace netloc Receiver_RX_FIFO_rstn 1 6 2 2860J 1470 3550
preplace netloc SPI_0_Rx_load_strobe 1 6 4 NJ 490 N 490 N 490 4810
preplace netloc SPI_0_SPI_clock 1 6 4 NJ 450 N 450 N 450 4840
preplace netloc SPI_0_SPI_data 1 6 4 NJ 470 N 470 N 470 4820
preplace netloc SPI_0_Tx_load_strobe 1 6 4 NJ 510 N 510 N 510 4800
preplace netloc SerialAtten_0_ATTN_CLK 1 6 4 2750J -50 N -50 N -50 4800
preplace netloc SerialAtten_0_ATTN_DATA 1 6 4 2760J -40 N -40 N -40 4820
preplace netloc SerialAtten_0_ATTN_LE 1 6 4 NJ 130 3560 -30 N -30 4830
preplace netloc SerialAtten_1_ATTN_CLK 1 6 4 2750J 120 N 120 N 120 4840
preplace netloc SerialAtten_1_ATTN_DATA 1 6 4 2760J 150 N 150 N 150 4850
preplace netloc SerialAtten_1_ATTN_LE 1 6 4 2770J 170 N 170 N 170 4870
preplace netloc TXConfig_1 1 4 2 1660 740 2170
preplace netloc TXLOTune_1 1 4 2 1680 760 2190
preplace netloc TX_ENABLE_0_1 1 0 6 NJ 770 NJ 770 N 770 1060 730 1550J 770 2210J
preplace netloc Transmitter_TX_FIFO_aresetn 1 6 2 2800J 720 3530
preplace netloc Transmitter_cw_ptt1 1 5 2 2270 980 2710
preplace netloc aclk_1 1 1 8 290 -50 NJ -50 N -50 NJ -50 NJ -50 2740J 160 NJ 160 4390J
preplace netloc adcrand_1 1 0 7 -230 -40 NJ -40 NJ -40 N -40 NJ -40 NJ -40 2700
preplace netloc aresetn_125_1 1 1 7 390 1610 N 1610 1060 1520 1750J 1190 NJ 1190 N 1190 3470
preplace netloc audio_codec_0_BCLK 1 6 4 2830J 970 NJ 970 NJ 970 4790
preplace netloc audio_codec_0_LRCLK 1 6 4 2820J 960 NJ 960 NJ 960 4880
preplace netloc audio_codec_0_MCLK 1 6 4 2830 1450 3450J 1590 4410J 1120 NJ
preplace netloc audio_codec_0_i2stxd 1 6 4 2800 1460 3420J 1610 4400J 1060 NJ
preplace netloc clk_wiz_0_clk_out2 1 1 7 320J 1370 630 1380 1060 1500 1760 1380 2160 1050 2840 1060 3470
preplace netloc clock_122_1 1 0 1 -260J 1350n
preplace netloc clock_122_in_n_1 1 0 1 -250J 1300n
preplace netloc clock_generator_clock_122_out 1 0 8 -230 1550 340 1360 640 1370 1070 1510 N 1510 2220 1030 2860 1040 3540
...
preplace netloc cw_key_1 1 5 2 2290 990 2720
preplace netloc is2rxd_1 1 0 6 NJ 740 N 740 N 740 960 720 1680 750 2150
preplace netloc keyer_config_1 1 4 2 1670 860 N
preplace netloc ref_in_10_1 1 0 2 -280J 1540 370
preplace netloc regmux_2_1_1_dout 1 6 4 2750J 240 N 240 N 240 N
preplace netloc reset_rtl_0_1 1 0 4 NJ 880 N 880 N 880 1020
preplace netloc status_in_1 1 0 6 NJ 550 N 550 N 550 N 550 1660 570 2110
preplace netloc tx_samples_1 1 5 2 2250 20 2710
preplace netloc util_reduced_logic_0_Res 1 1 9 280 -220 N -220 N -220 N -220 N -220 NJ -220 N -220 N -220 N
preplace netloc util_reduced_logic_1_Res 1 5 5 2280 1020 2740 460 N 460 N 460 4890
preplace netloc util_reduced_logic_2_Res 1 6 4 NJ 270 N 270 4440 310 4850
preplace netloc util_reduced_logic_3_Res 1 6 4 2750J 540 N 540 N 540 N
preplace netloc util_vector_logic_0_Res 1 3 7 980J -80 NJ -80 NJ -80 2840J -10 NJ -10 NJ -10 N
preplace netloc xlslice_0_Dout 1 6 4 2750J 320 N 320 N 320 4840
preplace netloc xlslice_0_Dout1 1 5 1 2230 40n
preplace netloc xlslice_1_Dout1 1 5 2 2240 30 2780
preplace netloc xlslice_2_Dout 1 5 1 2070 310n
preplace netloc xlslice_3_Dout 1 5 1 2120 410n
preplace netloc xlslice_4_Dout 1 5 4 2180 1000 2810J 710 NJ 710 4370J
preplace netloc xlslice_5_Dout 1 6 4 NJ 230 N 230 N 230 4880
preplace netloc CodecMicResetn_1 1 4 4 1720J 1130 NJ 1130 NJ 1130 3510
preplace netloc CodecSpkResetn_1 1 4 4 NJ 1450 NJ 1450 2700J 1490 N
preplace netloc FIFO_Interfaces_M_AXIS_codec 1 5 4 2280 1550 NJ 1550 NJ 1550 4370
preplace netloc PCIe_M03_AXI_0 1 4 4 1540J -100 NJ -100 2860 -30 3550
preplace netloc PCIe_M08_AXI_0 1 4 2 1610J 730 2150
preplace netloc PCIe_M09_AXI 1 4 2 N 950 2060
preplace netloc PCIe_M_AXI_Alex 1 4 2 1580 230 NJ
preplace netloc PCIe_M_AXI_full_0 1 4 4 NJ 890 2130J 1010 N 1010 3540
preplace netloc PCIe_SPI_0_0 1 4 6 NJ 910 2140J 970 2790J 690 N 690 4370 660 NJ
preplace netloc PCIe_pcie_7x_mgt_rtl_0 1 4 6 1560 -90 N -90 2850 -20 N -20 N -20 4890
preplace netloc Receiver_RX_Data 1 6 2 2850 1070 3510
preplace netloc S_AXIS_KeyerAmpl_1 1 5 3 2290 1080 NJ 1080 3500
preplace netloc S_AXIS_codec_1 1 6 2 2840 1100 NJ
preplace netloc TX_IQ_In_1 1 5 4 2260 1540 NJ 1540 N 1540 4380
preplace netloc Transmitter_m_axis_sidetoneampl 1 6 1 2750 730n
preplace netloc diff_clock_rtl_0_1 1 0 4 NJ 800 N 800 N 800 1030
preplace netloc s_axi_0_1 1 4 2 NJ 790 2110
preplace netloc s_axi_1_1 1 4 2 NJ 810 2090
...
if {[string equal [get_runs -quiet synth_2_copy_1] ""]} {
    create_run -name synth_2_copy_1 -part xc7a200tfbg676-2 -flow {Vivado Synthesis 2021} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1_copy_1] ""]} {
    create_run -name impl_1_copy_1 -part xc7a200tfbg676-2 -flow {Vivado Implementation 2021} -strategy "Performance_Auto_2" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2_copy_1
} else {
  set_property strategy "Performance_Auto_2" [get_runs impl_1_copy_1]
