...
#
# Generated by Vivado on Fri Aug 12 17:00:50 +0100 2022
...
# module references:
# clock_monitor, D_register_norst, D_register_norst, D_register_norst, D_register_norst, LTC2208_derandomise, LTC2208_derandomise, I2S_rcv, I2S_xmit, i2s_clk_lrclk_gen, axis_constant, cvt_offset_binary, regmux_4_1, AXIL_ConfigReg_256, AXIL_ConfigReg_64, AXIL_ReadReg_64, AXIL_ReadReg_64, AXI_ADC_overrange_reader, AXI_SPI_ADC, D_register, D_register, Double_D_register, Double_D_register, Usr_Reg_Access, AXIL_SPIWriter, ClockDivider, ClockDivider, PWM_DAC, SerialAtten, SerialAtten, regmux_2_1, regmux_2_1, regmux_2_1, regmux_2_1, ClockDivider, debounce, debounce, debounce, debounce, debounce, debounce, debounce, debounce
...
proc create_hier_cell_clock_generator { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 pll_cr
...
proc create_hier_cell_RF_interfaces { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net s_axi_alex_1 [get_bd_intf_pins s_axi_alex] [get_bd_intf_pins AXIL_SPIWriter_0/s_axi]

  # Create port connections
  connect_bd_net -net AXIL_SPIWriter_0_SPICk [get_bd_pins RF_SPI_CK] [get_bd_pins AXIL_SPIWriter_0/SPICk]
  connect_bd_net -net AXIL_SPIWriter_0_SPIData [get_bd_pins RF_SPI_DATA] [get_bd_pins AXIL_SPIWriter_0/SPIData]
  connect_bd_net -net AXIL_SPIWriter_0_SPILoad_0 [get_bd_pins RF_SPI_TX_LOAD] [get_bd_pins AXIL_SPIWriter_0/SPILoad_0]
  connect_bd_net -net AXIL_SPIWriter_0_SPILoad_1 [get_bd_pins RF_SPI_RX_LOAD] [get_bd_pins AXIL_SPIWriter_0/SPILoad_1]
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins AXIL_SPIWriter_0/aclk]
  ...
  connect_bd_net -net rstn_1 [get_bd_pins rstn] [get_bd_pins AXIL_SPIWriter_0/aresetn] [get_bd_pins AttenDrivers/rstn] [get_bd_pins debounce/rstn]
  ...
  connect_bd_net -net util_reduced_logic_3_Res [get_bd_pins Strobes/TXRX_RELAY] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_hier_cell_PCIe { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 3 -to 0 ClockMon
  ...
  connect_bd_net -net ClockMon_1 [get_bd_pins ClockMon] [get_bd_pins xlconcat_3/In0]
  ...
  connect_bd_net -net xlconstant_revision_dout [get_bd_pins xlconcat_3/In1] [get_bd_pins xlconstant_swversion/dout]
  connect_bd_net -net xlconstant_swid_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconstant_productversion/dout]
  connect_bd_net -net xlconstant_version_dout [get_bd_pins xlconcat_3/In2] [get_bd_pins xlconstant_swid/dout]
...
proc create_hier_cell_DACpath { parentCell nameHier } {
  ...
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins regmux_4_1_0/din3]
  connect_bd_net -net din0_1 [get_bd_pins din0] [get_bd_pins regmux_4_1_0/din0]
  connect_bd_net -net regmux_4_1_0_dout [get_bd_pins cvt_offset_binary_0/din] [get_bd_pins regmux_4_1_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins regmux_4_1_0/din2] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins sel] [get_bd_pins regmux_4_1_0/sel]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins resetn] [get_bd_pins regmux_4_1_0/resetn]
...
# Hierarchical cell: ADC_input
proc create_hier_cell_ADC_input { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_ADC_input() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -from 0 -to 0 ADC1Ovr_In_N
  create_bd_pin -dir I -from 0 -to 0 ADC1Ovr_In_P
  create_bd_pin -dir I -from 0 -to 0 ADC1_CLKin_N
  create_bd_pin -dir I -from 0 -to 0 ADC1_CLKin_P
  create_bd_pin -dir I -from 15 -to 0 ADC1_In_N
  create_bd_pin -dir I -from 15 -to 0 ADC1_In_P
  create_bd_pin -dir I -from 0 -to 0 ADC2Ovr_In_N
  create_bd_pin -dir I -from 0 -to 0 ADC2Ovr_In_P
  create_bd_pin -dir I -from 1 -to 0 ADC2_ATTEN_LE
  create_bd_pin -dir I -from 0 -to 0 ADC2_CLKin_N
  create_bd_pin -dir I -from 0 -to 0 ADC2_CLKin_P
  create_bd_pin -dir I -from 15 -to 0 ADC2_In_N
  create_bd_pin -dir I -from 15 -to 0 ADC2_In_P
  create_bd_pin -dir I -type clk aclk_inreg
  create_bd_pin -dir O -from 15 -to 0 adc1_dout
  create_bd_pin -dir O -from 0 -to 0 adc1_ovr
  create_bd_pin -dir O -from 15 -to 0 adc2_dout
  create_bd_pin -dir O -from 0 -to 0 adc2_ovr
  create_bd_pin -dir I -type clk clk

  # Create instance: D_register_norst_4, and set properties
  set block_name D_register_norst
  set block_cell_name D_register_norst_4
  if { [catch {set D_register_norst_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $D_register_norst_4 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create instance: D_register_norst_5, and set properties
  set block_name D_register_norst
  set block_cell_name D_register_norst_5
  if { [catch {set D_register_norst_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $D_register_norst_5 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: D_register_norst_6, and set properties
  set block_name D_register_norst
  set block_cell_name D_register_norst_6
  if { [catch {set D_register_norst_6 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $D_register_norst_6 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: D_register_norst_7, and set properties
  set block_name D_register_norst
  set block_cell_name D_register_norst_7
  if { [catch {set D_register_norst_7 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $D_register_norst_7 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
  ...
  # Create port connections
  connect_bd_net -net ADC1Ovr_In_N_1 [get_bd_pins ADC1Ovr_In_N] [get_bd_pins selectio_wiz_0/data_in_from_pins_n]
  connect_bd_net -net ADC1Ovr_In_P_1 [get_bd_pins ADC1Ovr_In_P] [get_bd_pins selectio_wiz_0/data_in_from_pins_p]
  ...
  connect_bd_net -net ADC1_In_N_1 [get_bd_pins ADC1_In_N] [get_bd_pins selectio_wiz_2/data_in_from_pins_n]
  connect_bd_net -net ADC1_In_P_1 [get_bd_pins ADC1_In_P] [get_bd_pins selectio_wiz_2/data_in_from_pins_p]
  connect_bd_net -net ADC2Ovr_In_N_1 [get_bd_pins ADC2Ovr_In_N] [get_bd_pins selectio_wiz_1/data_in_from_pins_n]
  connect_bd_net -net ADC2Ovr_In_P_1 [get_bd_pins ADC2Ovr_In_P] [get_bd_pins selectio_wiz_1/data_in_from_pins_p]
  ...
  connect_bd_net -net ADC2_In_N_1 [get_bd_pins ADC2_In_N] [get_bd_pins selectio_wiz_3/data_in_from_pins_n]
  connect_bd_net -net ADC2_In_P_1 [get_bd_pins ADC2_In_P] [get_bd_pins selectio_wiz_3/data_in_from_pins_p]
  connect_bd_net -net D_register_norst_4_dout [get_bd_pins adc2_ovr] [get_bd_pins D_register_norst_4/dout]
  connect_bd_net -net D_register_norst_5_dout [get_bd_pins D_register_norst_5/dout] [get_bd_pins LTC2208_derandomise_1/din]
  connect_bd_net -net D_register_norst_6_dout [get_bd_pins D_register_norst_6/dout] [get_bd_pins LTC2208_derandomise_0/din]
  connect_bd_net -net D_register_norst_7_dout [get_bd_pins adc1_ovr] [get_bd_pins D_register_norst_7/dout]
  connect_bd_net -net LTC2208_derandomise_0_dout [get_bd_pins adc1_dout] [get_bd_pins LTC2208_derandomise_0/dout]
  connect_bd_net -net LTC2208_derandomise_1_dout [get_bd_pins adc2_dout] [get_bd_pins LTC2208_derandomise_1/dout]
  connect_bd_net -net Net [get_bd_pins aclk_inreg] [get_bd_pins selectio_wiz_0/clk_in] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins selectio_wiz_2/clk_in] [get_bd_pins selectio_wiz_3/clk_in]
  ...
  connect_bd_net -net SerialAtten_1_ATTN_LE [get_bd_pins ADC2_ATTEN_LE] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_7/Din]
  connect_bd_net -net clock_generator_clock_122_out [get_bd_pins clk] [get_bd_pins D_register_norst_4/aclk] [get_bd_pins D_register_norst_5/aclk] [get_bd_pins D_register_norst_6/aclk] [get_bd_pins D_register_norst_7/aclk] [get_bd_pins LTC2208_derandomise_0/clk] [get_bd_pins LTC2208_derandomise_1/clk]
  connect_bd_net -net selectio_wiz_0_data_in_to_device [get_bd_pins D_register_norst_7/din] [get_bd_pins selectio_wiz_0/data_in_to_device]
  connect_bd_net -net selectio_wiz_1_data_in_to_device [get_bd_pins D_register_norst_4/din] [get_bd_pins selectio_wiz_1/data_in_to_device]
  connect_bd_net -net selectio_wiz_2_data_in_to_device [get_bd_pins D_register_norst_6/din] [get_bd_pins selectio_wiz_2/data_in_to_device]
  connect_bd_net -net selectio_wiz_3_data_in_to_device [get_bd_pins D_register_norst_5/din] [get_bd_pins selectio_wiz_3/data_in_to_device]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins LTC2208_derandomise_0/rand_sel] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins LTC2208_derandomise_1/rand_sel] [get_bd_pins xlslice_7/Dout]
  ...
  set clock_122_in_n [ create_bd_port -dir I -type clk -freq_hz 122880000 clock_122_in_n ]
  ...
  set pll_cr [ create_bd_port -dir O -from 0 -to 0 pll_cr ]
  set ref_in_10 [ create_bd_port -dir I ref_in_10 ]
  set status_in [ create_bd_port -dir I -from 9 -to 0 status_in ]

  # Create instance: ADC_input
  create_hier_cell_ADC_input [current_bd_instance .] ADC_input
  ...
  # Create port connections
  connect_bd_net -net ADC1Ovr_In_N_1 [get_bd_ports ADC1Ovr_In_N] [get_bd_pins ADC_input/ADC1Ovr_In_N]
  connect_bd_net -net ADC1Ovr_In_P_1 [get_bd_ports ADC1Ovr_In_P] [get_bd_pins ADC_input/ADC1Ovr_In_P]
  connect_bd_net -net ADC1_CLKin_N_1 [get_bd_ports ADC1_CLKin_N] [get_bd_pins ADC_input/ADC1_CLKin_N]
  connect_bd_net -net ADC1_CLKin_P_1 [get_bd_ports ADC1_CLKin_P] [get_bd_pins ADC_input/ADC1_CLKin_P]
  connect_bd_net -net ADC1_In_N_1 [get_bd_ports ADC1_In_N] [get_bd_pins ADC_input/ADC1_In_N]
  connect_bd_net -net ADC1_In_P_1 [get_bd_ports ADC1_In_P] [get_bd_pins ADC_input/ADC1_In_P]
  connect_bd_net -net ADC1_Overrange_1 [get_bd_pins ADC_input/adc1_ovr] [get_bd_pins PCIe/ADC1_Overrange]
  connect_bd_net -net ADC2Ovr_In_N_1 [get_bd_ports ADC2Ovr_In_N] [get_bd_pins ADC_input/ADC2Ovr_In_N]
  connect_bd_net -net ADC2Ovr_In_P_1 [get_bd_ports ADC2Ovr_In_P] [get_bd_pins ADC_input/ADC2Ovr_In_P]
  connect_bd_net -net ADC2_CLKin_N_1 [get_bd_ports ADC2_CLKin_N] [get_bd_pins ADC_input/ADC2_CLKin_N]
  connect_bd_net -net ADC2_CLKin_P_1 [get_bd_ports ADC2_CLKin_P] [get_bd_pins ADC_input/ADC2_CLKin_P]
  connect_bd_net -net ADC2_In_N_1 [get_bd_ports ADC2_In_N] [get_bd_pins ADC_input/ADC2_In_N]
  connect_bd_net -net ADC2_In_P_1 [get_bd_ports ADC2_In_P] [get_bd_pins ADC_input/ADC2_In_P]
  connect_bd_net -net ADC2_Overrange_1 [get_bd_pins ADC_input/adc2_ovr] [get_bd_pins PCIe/ADC2_Overrange]
  ...
  connect_bd_net -net ClockMon_1 [get_bd_pins PCIe/ClockMon] [get_bd_pins clock_monitor_0/dout]
  ...
  connect_bd_net -net LTC2208_derandomise_0_dout [get_bd_pins ADC_input/adc1_dout] [get_bd_pins DACpath/din0]
  connect_bd_net -net LTC2208_derandomise_1_dout [get_bd_pins ADC_input/adc2_dout] [get_bd_pins DACpath/din1]
  connect_bd_net -net Net [get_bd_pins ADC_input/aclk_inreg] [get_bd_pins clock_generator/clock_122_out_ADC]
  ...
  connect_bd_net -net PCIe_axi_aclk_125 [get_bd_pins PCIe/axi_aclk_125] [get_bd_pins clock_monitor_0/aclk]
  connect_bd_net -net PCIe_axi_aresetn_125 [get_bd_pins PCIe/axi_aresetn_125] [get_bd_pins clock_monitor_0/aresetn]
  ...
  connect_bd_net -net RF_interfaces_RF_SPI_DATA [get_bd_ports RF_SPI_DATA] [get_bd_pins RF_interfaces/RF_SPI_DATA]
  ...
  connect_bd_net -net SerialAtten_1_ATTN_LE [get_bd_ports ADC2_ATTEN_LE] [get_bd_pins ADC_input/ADC2_ATTEN_LE] [get_bd_pins RF_interfaces/ADC2_ATTEN_LE]
  ...
  connect_bd_net -net clock_generator_clock_122_out [get_bd_pins ADC_input/clk] [get_bd_pins DACpath/aclk] [get_bd_pins PCIe/clk_122] [get_bd_pins RF_interfaces/aclk] [get_bd_pins clock_generator/clock_122_out] [get_bd_pins clock_monitor_0/ck0] [get_bd_pins clock_monitor_0/ck3]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins DAC_LVDS_Pins/aresetn] [get_bd_pins DACpath/resetn] [get_bd_pins clock_generator/aresetn] [get_bd_pins xlslice_4/Dout]
  ...
  assign_bd_address -offset 0x0000B000 -range 0x00001000 -target_address_space [get_bd_addr_spaces PCIe/xdma_0/M_AXI_LITE] [get_bd_addr_segs RF_interfaces/AXIL_SPIWriter_0/s_axi/reg0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_Layers":"",
   "Default View_Layout":"",
   "Default View_ScaleFactor":"0.851457",
   "Default View_TopLeft":"1810,73",
...
#  -string -flagsOSRD
preplace port PROM_SPI -pg 1 -lvl 9 -x 3920 -y 860 -defaultsOSRD
preplace port iic_rtl_0 -pg 1 -lvl 9 -x 3920 -y 880 -defaultsOSRD
preplace port pcie_7x_mgt_rtl_0 -pg 1 -lvl 9 -x 3920 -y 900 -defaultsOSRD
preplace port pcie_diff_clock_rtl -pg 1 -lvl 0 -x -390 -y 870 -defaultsOSRD
preplace port port-id_ADC1Ovr_In_N -pg 1 -lvl 0 -x -390 -y 140 -defaultsOSRD
preplace port port-id_ADC1Ovr_In_P -pg 1 -lvl 0 -x -390 -y 160 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_CLK -pg 1 -lvl 9 -x 3920 -y 150 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_DAT -pg 1 -lvl 9 -x 3920 -y 170 -defaultsOSRD
preplace port port-id_ADC1_ATTEN_LE -pg 1 -lvl 9 -x 3920 -y 190 -defaultsOSRD
preplace port port-id_ADC1_CLKin_N -pg 1 -lvl 0 -x -390 -y 60 -defaultsOSRD
preplace port port-id_ADC1_CLKin_P -pg 1 -lvl 0 -x -390 -y 80 -defaultsOSRD
preplace port port-id_ADC2Ovr_In_N -pg 1 -lvl 0 -x -390 -y 260 -defaultsOSRD
preplace port port-id_ADC2Ovr_In_P -pg 1 -lvl 0 -x -390 -y 280 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_CLK -pg 1 -lvl 9 -x 3920 -y 210 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_DAT -pg 1 -lvl 9 -x 3920 -y 230 -defaultsOSRD
preplace port port-id_ADC2_ATTEN_LE -pg 1 -lvl 9 -x 3920 -y 250 -defaultsOSRD
preplace port port-id_ADC2_CLKin_N -pg 1 -lvl 0 -x -390 -y 180 -defaultsOSRD
preplace port port-id_ADC2_CLKin_P -pg 1 -lvl 0 -x -390 -y 200 -defaultsOSRD
preplace port port-id_ADC_MISO -pg 1 -lvl 0 -x -390 -y 930 -defaultsOSRD
preplace port port-id_BCLK -pg 1 -lvl 9 -x 3920 -y 1920 -defaultsOSRD
preplace port port-id_BUFF_Alex_Pin1 -pg 1 -lvl 0 -x -390 -y 330 -defaultsOSRD
preplace port port-id_BUFF_Alex_Pin8 -pg 1 -lvl 0 -x -390 -y 350 -defaultsOSRD
preplace port port-id_CTRL_TRSW -pg 1 -lvl 9 -x 3920 -y 330 -defaultsOSRD
preplace port port-id_DRIVER_PA_EN -pg 1 -lvl 9 -x 3920 -y 470 -defaultsOSRD
preplace port port-id_EMC_CLK -pg 1 -lvl 0 -x -390 -y 1800 -defaultsOSRD
preplace port port-id_LRCLK -pg 1 -lvl 9 -x 3920 -y 1940 -defaultsOSRD
preplace port port-id_MCLK -pg 1 -lvl 9 -x 3920 -y 1860 -defaultsOSRD
preplace port port-id_MOX_strobe -pg 1 -lvl 9 -x 3920 -y 490 -defaultsOSRD
preplace port port-id_PCIe_T_SMBCLK -pg 1 -lvl 0 -x -390 -y 950 -defaultsOSRD
preplace port port-id_PCIe_T_SMBDAT -pg 1 -lvl 0 -x -390 -y 970 -defaultsOSRD
preplace port port-id_RF_SPI_CK -pg 1 -lvl 9 -x 3920 -y 510 -defaultsOSRD
preplace port port-id_RF_SPI_DATA -pg 1 -lvl 9 -x 3920 -y 530 -defaultsOSRD
preplace port port-id_RF_SPI_RX_LOAD -pg 1 -lvl 9 -x 3920 -y 550 -defaultsOSRD
preplace port port-id_RF_SPI_TX_LOAD -pg 1 -lvl 9 -x 3920 -y 570 -defaultsOSRD
preplace port port-id_TX_DAC_PWM -pg 1 -lvl 9 -x 3920 -y 610 -defaultsOSRD
preplace port port-id_TX_ENABLE -pg 1 -lvl 0 -x -390 -y 1010 -defaultsOSRD
preplace port port-id_clock_122_in_p -pg 1 -lvl 0 -x -390 -y 1330 -defaultsOSRD
preplace port port-id_i2srxd -pg 1 -lvl 0 -x -390 -y 20 -defaultsOSRD
preplace port port-id_i2stxd -pg 1 -lvl 9 -x 3920 -y 1960 -defaultsOSRD
preplace port port-id_pcie_reset_n -pg 1 -lvl 0 -x -390 -y 1070 -defaultsOSRD
preplace port port-id_ref_in_10 -pg 1 -lvl 0 -x -390 -y 1350 -defaultsOSRD
preplace port port-id_clock_122_in_n -pg 1 -lvl 0 -x -390 -y 1480 -defaultsOSRD
preplace portBus ADC1_In_N -pg 1 -lvl 0 -x -390 -y 100 -defaultsOSRD
preplace portBus ADC1_In_P -pg 1 -lvl 0 -x -390 -y 120 -defaultsOSRD
preplace portBus ADC2_In_N -pg 1 -lvl 0 -x -390 -y 220 -defaultsOSRD
preplace portBus ADC2_In_P -pg 1 -lvl 0 -x -390 -y 240 -defaultsOSRD
preplace portBus ADC_CLK -pg 1 -lvl 9 -x 3920 -y 90 -defaultsOSRD
preplace portBus ADC_MOSI -pg 1 -lvl 9 -x 3920 -y 670 -defaultsOSRD
preplace portBus ATU_TUNE -pg 1 -lvl 9 -x 3920 -y 290 -defaultsOSRD
preplace portBus BLINK_LED -pg 1 -lvl 9 -x 3920 -y 1800 -defaultsOSRD
preplace portBus BUF_Out_FPGA -pg 1 -lvl 9 -x 3920 -y 310 -defaultsOSRD
preplace portBus DAC_Out_N -pg 1 -lvl 9 -x 3920 -y 750 -defaultsOSRD
preplace portBus DAC_Out_P -pg 1 -lvl 9 -x 3920 -y 770 -defaultsOSRD
preplace portBus Dac_Atten -pg 1 -lvl 9 -x 3920 -y 350 -defaultsOSRD
preplace portBus Dac_Atten_Clk -pg 1 -lvl 9 -x 3920 -y 370 -defaultsOSRD
preplace portBus Dac_Atten_Data -pg 1 -lvl 9 -x 3920 -y 390 -defaultsOSRD
preplace portBus Dac_Atten_LE -pg 1 -lvl 9 -x 3920 -y 410 -defaultsOSRD
preplace portBus Dac_Atten_Mode -pg 1 -lvl 9 -x 3920 -y 430 -defaultsOSRD
preplace portBus FPGA_CM4_EN -pg 1 -lvl 9 -x 3920 -y 690 -defaultsOSRD
preplace portBus GPIO_OUT -pg 1 -lvl 9 -x 3920 -y 450 -defaultsOSRD
preplace portBus LEDOutputs -pg 1 -lvl 9 -x 3920 -y 800 -defaultsOSRD
preplace portBus PCIECLKREQN -pg 1 -lvl 9 -x 3920 -y 820 -defaultsOSRD
preplace portBus PCI_LINK_LED -pg 1 -lvl 9 -x 3920 -y -60 -defaultsOSRD
preplace portBus TXRX_RELAY -pg 1 -lvl 9 -x 3920 -y 590 -defaultsOSRD
preplace portBus nADC_CS -pg 1 -lvl 9 -x 3920 -y 1280 -defaultsOSRD
preplace portBus pll_cr -pg 1 -lvl 9 -x 3920 -y 1980 -defaultsOSRD
preplace portBus status_in -pg 1 -lvl 0 -x -390 -y 610 -defaultsOSRD
preplace inst DAC_LVDS_Pins -pg 1 -lvl 8 -x 3350 -y 700 -defaultsOSRD
preplace inst PCIe -pg 1 -lvl 6 -x 2180 -y 810 -defaultsOSRD
preplace inst RF_interfaces -pg 1 -lvl 8 -x 3350 -y -620 -defaultsOSRD
preplace inst clock_generator -pg 1 -lvl 3 -x 990 -y 1924 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 8 -x 3350 -y 1010 -defaultsOSRD
preplace inst xlslice_4 -pg 1 -lvl 1 -x -160 -y 1410 -defaultsOSRD
preplace inst Audio_b2b -pg 1 -lvl 8 -x 3350 -y 1880 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 7 -x 2580 -y 1190 -defaultsOSRD
preplace inst DACpath -pg 1 -lvl 8 -x 3350 -y 860 -defaultsOSRD
preplace inst ADC_input -pg 1 -lvl 2 -x 470 -y 150 -defaultsOSRD
preplace inst clock_monitor_0 -pg 1 -lvl 4 -x 1440 -y 1550 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 5 -x 1720 -y 1300 -defaultsOSRD
preplace netloc ADC1Ovr_In_N_1 1 0 2 NJ 140 -60J
preplace netloc ADC1Ovr_In_P_1 1 0 2 -300J 150 NJ
preplace netloc ADC1_CLKin_N_1 1 0 2 NJ 60 -30
preplace netloc ADC1_CLKin_P_1 1 0 2 NJ 80 -40
preplace netloc ADC1_In_N_1 1 0 2 -360J 50 NJ
preplace netloc ADC1_In_P_1 1 0 2 -370J 30 NJ
preplace netloc ADC1_Overrange_1 1 2 4 660 170 NJ 170 N 170 1920
preplace netloc ADC2Ovr_In_N_1 1 0 2 -280J 130 NJ
preplace netloc ADC2Ovr_In_P_1 1 0 2 -290J 110 NJ
preplace netloc ADC2_CLKin_N_1 1 0 2 NJ 180 -50
preplace netloc ADC2_CLKin_P_1 1 0 2 NJ 200 -60
preplace netloc ADC2_In_N_1 1 0 2 -320J 90 NJ
preplace netloc ADC2_In_P_1 1 0 2 -330J 70 NJ
preplace netloc ADC2_Overrange_1 1 2 4 NJ 180 NJ 180 N 180 1880
preplace netloc ADC_Ctrl_1 1 6 2 2350 -700 N
preplace netloc ADC_MISO_0_1 1 0 6 NJ 930 NJ 930 N 930 NJ 930 N 930 1880
preplace netloc BUFF_Alex_Pin1_0_1 1 0 8 -350J -90 NJ -90 N -90 NJ -90 N -90 1870 -150 NJ -150 2680
preplace netloc BUFF_Alex_Pin8_0_1 1 0 8 -340J -70 -60J -80 N -80 NJ -80 N -80 1880 -140 NJ -140 2700
preplace netloc ClockMon_1 1 4 2 1550 1110 1960
preplace netloc DAC_Ctrl_1 1 6 2 2370 -120 2740
preplace netloc DAC_LVDS_Pins_DAC_Out_N 1 8 1 3560J 690n
preplace netloc DAC_LVDS_Pins_DAC_Out_P 1 8 1 3530J 710n
preplace netloc EMC_CLK_1 1 0 4 NJ 1800 NJ 1800 NJ 1800 1170
preplace netloc I2S_xmit_0_outbit 1 8 1 3520J 1900n
preplace netloc LTC2208_derandomise_0_dout 1 2 6 N 120 N 120 N 120 N 120 2430 310 2770
preplace netloc LTC2208_derandomise_1_dout 1 2 6 N 140 N 140 N 140 N 140 2390 320 2740
preplace netloc Net 1 1 3 -30 1814 N 1814 1140
preplace netloc PCIe_ADC_CLK 1 6 3 2380J 300 2680 90 NJ
preplace netloc PCIe_ADC_MOSI 1 6 3 NJ 790 2780 580 3610J
preplace netloc PCIe_FPGA_CM4_EN 1 6 3 NJ 850 2690 590 3600J
preplace netloc PCIe_LEDDrivers 1 6 3 NJ 890 2710 600 3570J
preplace netloc PCIe_PCIECLKREQN 1 6 3 NJ 910 2730 610 3540J
preplace netloc PCIe_PCI_LINK_LED 1 6 3 2410 -60 NJ -60 NJ
preplace netloc PCIe_RFGPIOData 1 6 2 2400 -100 2750
preplace netloc PCIe_TXConfigData 1 6 1 2400 970n
preplace netloc PCIe_TXFreqData 1 6 2 2420 930 2820
preplace netloc PCIe_T_SMBCLK_0_1 1 0 6 NJ 950 NJ 950 N 950 NJ 950 N 950 1910
preplace netloc PCIe_T_SMBDAT_0_1 1 0 6 NJ 970 NJ 970 N 970 NJ 970 N 970 1920
preplace netloc PCIe_axi_aclk_125 1 3 4 1200 1670 NJ 1670 N 1670 2350
preplace netloc PCIe_axi_aresetn_125 1 3 4 1210 1660 NJ 1660 NJ 1660 2340
preplace netloc PCIe_axi_resetn 1 0 8 -280 430 NJ 430 N 430 N 430 N 430 N 430 2360 1010 N
preplace netloc PCIe_nADC_CS 1 6 3 NJ 1110 2680 1280 NJ
preplace netloc PWM_DAC_0_DAC_bit 1 8 1 3620J -400n
preplace netloc RF_interfaces_BUF_Out_FPGA 1 8 1 3770J -700n
preplace netloc RF_interfaces_Dac_Atten_Clk 1 8 1 3740J -620n
preplace netloc RF_interfaces_Dac_Atten_Data 1 8 1 3730J -600n
preplace netloc RF_interfaces_Dac_Atten_LE 1 8 1 3720J -580n
preplace netloc RF_interfaces_Dac_Atten_Mode 1 8 1 3710J -560n
preplace netloc RF_interfaces_RF_SPI_DATA 1 8 1 3670 -480n
preplace netloc RF_interfaces_status_out 1 5 4 1930 -80 NJ -80 N -80 3520
preplace netloc SPI_0_Rx_load_strobe 1 8 1 3660J -460n
preplace netloc SPI_0_SPI_clock 1 8 1 3680J -500n
preplace netloc SPI_0_Tx_load_strobe 1 8 1 3650J -440n
preplace netloc SerialAtten_0_ATTN_CLK 1 8 1 3830J -860n
preplace netloc SerialAtten_0_ATTN_DATA 1 8 1 3820J -840n
preplace netloc SerialAtten_0_ATTN_LE 1 8 1 3810J -820n
preplace netloc SerialAtten_1_ATTN_CLK 1 8 1 3800J -800n
preplace netloc SerialAtten_1_ATTN_DATA 1 8 1 3790J -780n
preplace netloc SerialAtten_1_ATTN_LE 1 1 8 -50 340 N 340 N 340 N 340 N 340 N 340 2690 250 3640J
preplace netloc TX_ENABLE_0_1 1 0 6 NJ 1010 NJ 1010 N 1010 NJ 1010 N 1010 1930
preplace netloc aclk_1 1 3 5 1190 1160 N 1160 N 1160 2430J 920 2810J
preplace netloc arstn_1 1 6 2 NJ 1030 2690
preplace netloc clock_122_1 1 0 3 NJ 1330 NJ 1330 650
preplace netloc clock_122_in_n_1 1 0 3 NJ 1480 NJ 1480 640
preplace netloc clock_generator_clock_122_out 1 1 7 -30 -60 N -60 1150 160 N 160 1890 330 N 330 2800
preplace netloc clock_generator_pll_lock 1 3 3 1180 1090 N 1090 1950
preplace netloc clock_monitor_0_LED 1 4 1 1560 1300n
preplace netloc codec_clk_1 1 3 6 1160 1060 N 1060 1900 440 NJ 440 2790J 1950 3820
preplace netloc cvt_offset_binary_0_dout 1 7 2 2810 620 3510
preplace netloc i2s_clk_lrclk_gen_0_BCLK 1 8 1 3700J 1860n
preplace netloc i2s_clk_lrclk_gen_0_LRCLK 1 8 1 3560J 1880n
preplace netloc i2srxd_1 1 0 8 NJ 20 -40J -50 N -50 NJ -50 N -50 N -50 NJ -50 2700
preplace netloc ref_in_10_1 1 0 4 NJ 1350 NJ 1350 630 1560 N
preplace netloc regmux_2_1_1_dout 1 8 1 3750J -640n
preplace netloc reset_rtl_0_1 1 0 6 NJ 1070 NJ 1070 N 1070 NJ 1070 N 1070 1940
preplace netloc status_in_1 1 0 8 -310J 10 -50J -70 N -70 NJ -70 N -70 1890 -90 NJ -90 2770
preplace netloc util_reduced_logic_0_Res 1 3 6 NJ 1934 N 1934 N 1934 NJ 1934 2690 1980 NJ
preplace netloc util_reduced_logic_1_Res 1 8 1 3690 -520n
preplace netloc util_reduced_logic_2_Res 1 8 1 3760J -680n
preplace netloc util_reduced_logic_3_Res 1 8 1 3630J -420n
preplace netloc util_vector_logic_0_Res 1 5 4 NJ 1300 NJ 1300 NJ 1300 3670
preplace netloc xlslice_0_Dout 1 8 1 3700J -540n
preplace netloc xlslice_0_Dout1 1 7 2 2810 -70 3520
preplace netloc xlslice_1_Dout 1 7 1 2830 870n
preplace netloc xlslice_4_Dout 1 1 7 NJ 1410 660 450 N 450 N 450 N 450 N 450 2750
preplace netloc xlslice_5_Dout 1 8 1 3780J -720n
preplace netloc PCIe_M_AXI_Alex 1 6 2 2340 -720 N
preplace netloc PCIe_SPI_0_0 1 6 3 NJ 690 2680 550 3590J
preplace netloc PCIe_iic_rtl_0 1 6 3 NJ 710 2720 560 3580J
preplace netloc PCIe_pcie_7x_mgt_rtl_0 1 6 3 NJ 730 2760 570 3550J
preplace netloc diff_clock_rtl_0_1 1 0 6 NJ 870 NJ 870 N 870 NJ 870 N 870 1870
...
preplace cgraphic comment_1 place left -605 -47 textcolor 4 linecolor 3
preplace cgraphic comment_0 place left 301 84 textcolor 4 linecolor 3
levelinfo -pg 1 -390 -160 470 990 1440 1720 2180 2580 3350 3920
pagesize -pg 1 -db -bbox -sgen -560 -1510 4110 3850
",
   "linecolor_comment_1":"",
