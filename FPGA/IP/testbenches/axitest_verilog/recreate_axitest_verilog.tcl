...
#
# Generated by Vivado on Tue Sep 26 20:27:15 +0100 2023
...
# AXILite_Alex_SPI, AXI_ADC_overrange_reader, AXI_FIFO_overflow_reader, AXI_SPI_ADC, FIFO_Monitor
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins AXILite_Alex_SPI_0/aclk] [get_bd_pins AXI_ADC_overrange_re_0/aclk] [get_bd_pins AXI_FIFO_overflow_re_0/aclk] [get_bd_pins AXI_SPI_ADC_0/aclk] [get_bd_pins FIFO_Monitor_0/aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk]
  ...
  connect_bd_net -net axis_data_fifo_0_axis_rd_data_count [get_bd_pins FIFO_Monitor_0/fifo2_count] [get_bd_pins axis_data_fifo_0/axis_rd_data_count]
  connect_bd_net -net axis_data_fifo_0_axis_wr_data_count [get_bd_pins FIFO_Monitor_0/fifo1_count] [get_bd_pins axis_data_fifo_0/axis_wr_data_count]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins xlconstant_2/dout]
