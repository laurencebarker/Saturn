...
#
# Generated by Vivado on Fri Oct 14 19:01:20 +0100 2022
...
#    "C:/xilinxdesigns/Saturn/FPGA/IP/testbenches/axitest_verilog/AXI_GPIO_Sim_wrapper.v"
...
if { [get_files AXILite_Alex_SPI.v] == "" } {
  import_files -quiet -fileset sources_1 c:/xilinxdesigns/Saturn/FPGA/IP/testbenches/axitest_verilog/axitest_verilog/axitest_verilog.srcs/sources_1/imports/axitest_verilog/AXILite_Alex_SPI.v
}
if { [get_files AXI_ADC_overrange_latch_reader.v] == "" } {
  import_files -quiet -fileset sources_1 c:/xilinxdesigns/Saturn/FPGA/IP/testbenches/axitest_verilog/axitest_verilog/axitest_verilog.srcs/sources_1/imports/axitest_verilog/AXI_ADC_overrange_latch_reader.v
}
if { [get_files axi_spi_adc.v] == "" } {
  import_files -quiet -fileset sources_1 c:/xilinxdesigns/Saturn/FPGA/IP/testbenches/axitest_verilog/axitest_verilog/axitest_verilog.srcs/sources_1/imports/axitest_verilog/axi_spi_adc.v
}
if { [get_files FIFO_Monitor.v] == "" } {
  import_files -quiet -fileset sources_1 c:/xilinxdesigns/Saturn/FPGA/IP/testbenches/axitest_verilog/axitest_verilog/axitest_verilog.srcs/sources_1/imports/axitest_verilog/FIFO_Monitor.v
}
...
# module references:
# AXILite_Alex_SPI, AXI_ADC_overrange_reader, AXI_FIFO_overflow_reader, AXI_SPI_ADC, FIFO_Monitor
