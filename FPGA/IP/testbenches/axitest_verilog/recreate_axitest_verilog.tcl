...
#
# Generated by Vivado on Wed Jun 09 19:43:28 +0100 2021
...
#
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/axi_spi_adc.v"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/FIFO_Monitor.v"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXILite_Alex_SPI.v"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXI_ADC_overrange_latch_reader.v"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXI_GPIO_Sim_wrapper.v"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXI_GPIO_tb2.sv"
#    "E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXI_GPIO_tb_behav.wcfg"
#
...
set file "axitest_verilog/AXI_GPIO_tb2.sv"
...
if { [get_files axi_spi_adc.v] == "" } {
  import_files -quiet -fileset sources_1 E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/axi_spi_adc.v
}
if { [get_files FIFO_Monitor.v] == "" } {
  import_files -quiet -fileset sources_1 E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/FIFO_Monitor.v
}
if { [get_files AXILite_Alex_SPI.v] == "" } {
  import_files -quiet -fileset sources_1 E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXILite_Alex_SPI.v
}
if { [get_files AXI_ADC_overrange_latch_reader.v] == "" } {
  import_files -quiet -fileset sources_1 E:/xilinxdesigns/saturn/FPGA/IP/testbenches/axitest_verilog/AXI_ADC_overrange_latch_reader.v
}
...
# module references:
# AXILite_Alex_SPI, AXI_ADC_overrange_reader, AXI_SPI_ADC, FIFO_Monitor
  ...
  connect_bd_net -net AXILite_Alex_SPI_0_Rx_load_strobe [get_bd_ports Rx_load_strobe] [get_bd_pins AXILite_Alex_SPI_0/Rx_load_strobe]
  connect_bd_net -net AXILite_Alex_SPI_0_SPI_clock [get_bd_ports SPI_ck] [get_bd_pins AXILite_Alex_SPI_0/SPI_ck]
  connect_bd_net -net AXILite_Alex_SPI_0_SPI_data [get_bd_ports SPI_data] [get_bd_pins AXILite_Alex_SPI_0/SPI_data]
  connect_bd_net -net AXILite_Alex_SPI_0_Tx_load_strobe [get_bd_ports Tx_load_strobe] [get_bd_pins AXILite_Alex_SPI_0/Tx_load_strobe]
  connect_bd_net -net AXI_SPI_ADC_0_MOSI [get_bd_ports MOSI] [get_bd_pins AXI_SPI_ADC_0/MOSI]
  connect_bd_net -net AXI_SPI_ADC_0_SCLK [get_bd_ports SCLK] [get_bd_pins AXI_SPI_ADC_0/SCLK]
  connect_bd_net -net AXI_SPI_ADC_0_nCS [get_bd_ports nCS] [get_bd_pins AXI_SPI_ADC_0/nCS]
  connect_bd_net -net FIFO_Monitor_0_int2_out [get_bd_ports int2_out] [get_bd_pins FIFO_Monitor_0/int2_out]
  connect_bd_net -net FIFO_Monitor_0_int3_out [get_bd_ports int3_out] [get_bd_pins FIFO_Monitor_0/int3_out]
  connect_bd_net -net FIFO_Monitor_0_int4_out [get_bd_ports int4_out] [get_bd_pins FIFO_Monitor_0/int4_out]
  connect_bd_net -net FIFO_Monitor_0_int_out [get_bd_ports int1_out] [get_bd_pins FIFO_Monitor_0/int1_out]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk] [get_bd_pins AXILite_Alex_SPI_0/aclk] [get_bd_pins AXI_ADC_overrange_re_0/aclk] [get_bd_pins AXI_SPI_ADC_0/aclk] [get_bd_pins FIFO_Monitor_0/aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_vip_0/aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn] [get_bd_pins AXILite_Alex_SPI_0/aresetn] [get_bd_pins AXI_ADC_overrange_re_0/aresetn] [get_bd_pins AXI_SPI_ADC_0/aresetn] [get_bd_pins FIFO_Monitor_0/aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_vip_0/aresetn]
  connect_bd_net -net fifo2_count_0_1 [get_bd_ports fifo2_count] [get_bd_pins FIFO_Monitor_0/fifo2_count]
  connect_bd_net -net fifo2_overflow_0_1 [get_bd_ports fifo2_overflow] [get_bd_pins FIFO_Monitor_0/fifo2_overflow]
  connect_bd_net -net fifo3_overflow_0_1 [get_bd_ports fifo3_overflow] [get_bd_pins FIFO_Monitor_0/fifo3_overflow]
  connect_bd_net -net fifo4_overflow_0_1 [get_bd_ports fifo4_overflow] [get_bd_pins FIFO_Monitor_0/fifo4_overflow]
  connect_bd_net -net fifo_count_0_1 [get_bd_ports fifo1_count] [get_bd_pins FIFO_Monitor_0/fifo1_count]
  connect_bd_net -net fifo_overflow_0_1 [get_bd_ports fifo1_overflow] [get_bd_pins FIFO_Monitor_0/fifo1_overflow]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins FIFO_Monitor_0/fifo3_count] [get_bd_pins FIFO_Monitor_0/fifo4_count] [get_bd_pins xlconstant_0/dout]
