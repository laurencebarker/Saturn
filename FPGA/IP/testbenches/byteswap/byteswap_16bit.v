...
// Design Name:    byteswap_32bit.v
// Module Name:    byteswap_32
// Project Name:   Saturn 
// Target Devices: Artix 7
// Tool Versions:  Vivado
// Description:    Module to swap bytes for a 16 bit Mic data word
...
// if swap selected, codec data will be transferred in byteswapped 
  ...
  input wire                        m_axis_tready
    ...
    begin
        ...
        begin 
            ...
            begin
                m_axis_tvalid <= 1; 
                m_axis_tdata <= swap ? {s_axis_tdata[7:0], s_axis_tdata[15:8]}:s_axis_tdata;
            end
