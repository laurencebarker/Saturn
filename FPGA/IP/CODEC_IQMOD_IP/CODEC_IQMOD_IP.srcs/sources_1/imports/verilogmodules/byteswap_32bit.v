...
// Description:    Module to swap bytes for a 32 bit Codec word
  ...
  input wire                        m_axis_tready
    ...
    begin
        ...
        begin 
            ...
            begin
                m_axis_tvalid <= 1; 
                m_axis_tdata <= swap ? {s_axis_tdata[23:16], s_axis_tdata[31:24], s_axis_tdata[7:0], s_axis_tdata[15:8]}:s_axis_tdata;
            end
